...
import com.konfigthis.client.model.FlagEventCollectionRep;
...
public class InsightsFlagEventsBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public InsightsFlagEventsBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public InsightsFlagEventsBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listFlagEventsCall(String projectKey, String environmentKey, String applicationKey, String query, String impactSize, Boolean hasExperiments, String global, String expand, Long limit, Long from, Long to, String after, String before, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listFlagEventsValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, String query, String impactSize, Boolean hasExperiments, String global, String expand, Long limit, Long from, Long to, String after, String before, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling listFlagEvents(Async)");
        }

        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling listFlagEvents(Async)");
        }

        return listFlagEventsCall(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before, _callback);

    }


    private ApiResponse<FlagEventCollectionRep> listFlagEventsWithHttpInfo(String projectKey, String environmentKey, String applicationKey, String query, String impactSize, Boolean hasExperiments, String global, String expand, Long limit, Long from, Long to, String after, String before) throws ApiException {
        okhttp3.Call localVarCall = listFlagEventsValidateBeforeCall(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before, null);
        Type localVarReturnType = new TypeToken<FlagEventCollectionRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listFlagEventsAsync(String projectKey, String environmentKey, String applicationKey, String query, String impactSize, Boolean hasExperiments, String global, String expand, Long limit, Long from, Long to, String after, String before, final ApiCallback<FlagEventCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = listFlagEventsValidateBeforeCall(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before, _callback);
        Type localVarReturnType = new TypeToken<FlagEventCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListFlagEventsRequestBuilder {
        ...
        private ListFlagEventsRequestBuilder(String projectKey, String environmentKey) {
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder applicationKey(String applicationKey) {
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder query(String query) {
            this.query = query;
            return this;
        }
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder impactSize(String impactSize) {
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder hasExperiments(Boolean hasExperiments) {
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder global(String global) {
            this.global = global;
            return this;
        }
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder expand(String expand) {
            this.expand = expand;
            return this;
        }
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder limit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder from(Long from) {
            this.from = from;
            return this;
        }
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder to(Long to) {
            this.to = to;
            return this;
        }
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListFlagEventsRequestBuilder
         */
        public ListFlagEventsRequestBuilder before(String before) {
            this.before = before;
            return this;
        }
        
        /**
         * Build call for listFlagEvents
        ...
        /**
         * Execute listFlagEvents request
         ...
         */
        public FlagEventCollectionRep execute() throws ApiException {
            ApiResponse<FlagEventCollectionRep> localVarResp = listFlagEventsWithHttpInfo(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listFlagEvents request with HTTP info returned
         ...
         */
        public ApiResponse<FlagEventCollectionRep> executeWithHttpInfo() throws ApiException {
            return listFlagEventsWithHttpInfo(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before);
        }

        /**
         * Execute listFlagEvents request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FlagEventCollectionRep> _callback) throws ApiException {
            return listFlagEventsAsync(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before, _callback);
        }
    }
     ...
     */
    public ListFlagEventsRequestBuilder listFlagEvents(String projectKey, String environmentKey) throws IllegalArgumentException {
        ...
        return new ListFlagEventsRequestBuilder(projectKey, environmentKey);
    }
}
