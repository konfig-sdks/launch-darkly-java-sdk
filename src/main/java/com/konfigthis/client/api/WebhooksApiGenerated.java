...
import com.konfigthis.client.model.WebhookPost;
...
public class WebhooksApiGenerated {
    ...
    private okhttp3.Call createNewWebhookCall(WebhookPost webhookPost, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNewWebhookValidateBeforeCall(WebhookPost webhookPost, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'webhookPost' is set
        if (webhookPost == null) {
            throw new ApiException("Missing the required parameter 'webhookPost' when calling createNewWebhook(Async)");
        }

        return createNewWebhookCall(webhookPost, _callback);

    }


    private ApiResponse<Webhook> createNewWebhookWithHttpInfo(WebhookPost webhookPost) throws ApiException {
        okhttp3.Call localVarCall = createNewWebhookValidateBeforeCall(webhookPost, null);
        Type localVarReturnType = new TypeToken<Webhook>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewWebhookAsync(WebhookPost webhookPost, final ApiCallback<Webhook> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewWebhookValidateBeforeCall(webhookPost, _callback);
        Type localVarReturnType = new TypeToken<Webhook>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewWebhookRequestBuilder {
        ...
        private CreateNewWebhookRequestBuilder(String url, Boolean sign) {
            this.url = url;
            this.sign = sign;
        }
        ...
        /**
         * Set tags
         * @param tags List of tags for this webhook (optional)
         * @return CreateNewWebhookRequestBuilder
         */
        public CreateNewWebhookRequestBuilder tags(List<String> tags) {
            this.tags = tags;
            return this;
        }
        ...
        /**
         * Set name
         * @param name A human-readable name for your webhook (optional)
         * @return CreateNewWebhookRequestBuilder
         */
        public CreateNewWebhookRequestBuilder name(String name) {
            this.name = name;
            return this;
        }
        ...
        /**
         * Set secret
         * @param secret If sign is true, and the secret attribute is omitted, LaunchDarkly automatically generates a secret for you. (optional)
         * @return CreateNewWebhookRequestBuilder
         */
        public CreateNewWebhookRequestBuilder secret(String secret) {
            this.secret = secret;
            return this;
        }
         ...
         * @return CreateNewWebhookRequestBuilder
         */
        public CreateNewWebhookRequestBuilder statements(List<StatementPost> statements) {
        ...
        /**
         * Set true
         * @param true Whether or not this webhook is enabled. (optional)
         * @return CreateNewWebhookRequestBuilder
         */
        public CreateNewWebhookRequestBuilder true(Boolean true) {
            this.true = true;
            return this;
        }
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            WebhookPost webhookPost = buildBodyParams();
            return createNewWebhookCall(webhookPost, _callback);
        }

        private WebhookPost buildBodyParams() {
            WebhookPost webhookPost = new WebhookPost();
            webhookPost.tags(this.tags);
            webhookPost.name(this.name);
            webhookPost.url(this.url);
            webhookPost.secret(this.secret);
            webhookPost.statements(this.statements);
            webhookPost.sign(this.sign);
            webhookPost.true(this.true);
            return webhookPost;
        }

        /**
         * Execute createNewWebhook request
         * @return Webhook
        ...
        public Webhook execute() throws ApiException {
            WebhookPost webhookPost = buildBodyParams();
            ApiResponse<Webhook> localVarResp = createNewWebhookWithHttpInfo(webhookPost);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewWebhook request with HTTP info returned
        ...
        public ApiResponse<Webhook> executeWithHttpInfo() throws ApiException {
            WebhookPost webhookPost = buildBodyParams();
            return createNewWebhookWithHttpInfo(webhookPost);
        }

        /**
         * Execute createNewWebhook request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Webhook> _callback) throws ApiException {
            WebhookPost webhookPost = buildBodyParams();
            return createNewWebhookAsync(webhookPost, _callback);
        }
    }
     ...
     */
    public CreateNewWebhookRequestBuilder createNewWebhook(String url, Boolean sign) throws IllegalArgumentException {
        if (url == null) throw new IllegalArgumentException("\"url\" is required but got null");
            

        if (sign == null) throw new IllegalArgumentException("\"sign\" is required but got null");
        return new CreateNewWebhookRequestBuilder(url, sign);
    }
    ...
    private ApiResponse<Webhook> getSingleByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Webhook>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleByIdAsync(String id, final ApiCallback<Webhook> _callback) throws ApiException {
    ...
    public class GetSingleByIdRequestBuilder {
         ...
         */
        public Webhook execute() throws ApiException {
            ApiResponse<Webhook> localVarResp = getSingleByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private ApiResponse<Webhooks> listWebhooksWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listWebhooksValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Webhooks>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listWebhooksAsync(final ApiCallback<Webhooks> _callback) throws ApiException {
    ...
    public class ListWebhooksRequestBuilder {
        ...
        public Webhooks execute() throws ApiException {
            ApiResponse<Webhooks> localVarResp = listWebhooksWithHttpInfo();
            return localVarResp.getResponseBody();
        }
    ...
    private okhttp3.Call updateSettingsPatchCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSettingsPatchValidateBeforeCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSettingsPatch(Async)");
        }

        // verify the required parameter 'patchOperation' is set
        if (patchOperation == null) {
            throw new ApiException("Missing the required parameter 'patchOperation' when calling updateSettingsPatch(Async)");
        }

        return updateSettingsPatchCall(id, patchOperation, _callback);

    }


    private ApiResponse<Webhook> updateSettingsPatchWithHttpInfo(String id, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = updateSettingsPatchValidateBeforeCall(id, patchOperation, null);
        Type localVarReturnType = new TypeToken<Webhook>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSettingsPatchAsync(String id, List<PatchOperation> patchOperation, final ApiCallback<Webhook> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSettingsPatchValidateBeforeCall(id, patchOperation, _callback);
        Type localVarReturnType = new TypeToken<Webhook>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSettingsPatchRequestBuilder {
        private final String id;
        private List<PatchOperation> patchOperation;

        private UpdateSettingsPatchRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * @return UpdateSettingsPatchRequestBuilder
         */
        public UpdateSettingsPatchRequestBuilder patchOperation(List<PatchOperation> patchOperation) {
            this.patchOperation = patchOperation;
            return this;
        }

        /**
         * Build call for updateSettingsPatch
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute updateSettingsPatch request
         * @return Webhook
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public Webhook execute() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            ApiResponse<Webhook> localVarResp = updateSettingsPatchWithHttpInfo(id, patchOperation);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSettingsPatch request with HTTP info returned
         * @return ApiResponse&lt;Webhook&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<Webhook> executeWithHttpInfo() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateSettingsPatchWithHttpInfo(id, patchOperation);
        }

        /**
         * Execute updateSettingsPatch request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Webhook> _callback) throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateSettingsPatchAsync(id, patchOperation, _callback);
        }
    }
     ...
     */
    public UpdateSettingsPatchRequestBuilder updateSettingsPatch(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSettingsPatchRequestBuilder(id);
    }
}
