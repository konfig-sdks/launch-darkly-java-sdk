...
import com.konfigthis.client.model.MemberTeamsPostInput;
import com.konfigthis.client.model.Members;
import com.konfigthis.client.model.NewMemberForm;
...
public class AccountMembersApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AccountMembersApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AccountMembersApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call addToTeamsCall(String id, MemberTeamsPostInput memberTeamsPostInput, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call addToTeamsValidateBeforeCall(String id, MemberTeamsPostInput memberTeamsPostInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling addToTeams(Async)");
        }

        // verify the required parameter 'memberTeamsPostInput' is set
        if (memberTeamsPostInput == null) {
            throw new ApiException("Missing the required parameter 'memberTeamsPostInput' when calling addToTeams(Async)");
        }

        return addToTeamsCall(id, memberTeamsPostInput, _callback);

    }


    private ApiResponse<Member> addToTeamsWithHttpInfo(String id, MemberTeamsPostInput memberTeamsPostInput) throws ApiException {
        okhttp3.Call localVarCall = addToTeamsValidateBeforeCall(id, memberTeamsPostInput, null);
        Type localVarReturnType = new TypeToken<Member>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call addToTeamsAsync(String id, MemberTeamsPostInput memberTeamsPostInput, final ApiCallback<Member> _callback) throws ApiException {

        okhttp3.Call localVarCall = addToTeamsValidateBeforeCall(id, memberTeamsPostInput, _callback);
        Type localVarReturnType = new TypeToken<Member>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class AddToTeamsRequestBuilder {
        private final List<String> teamKeys;
        private final String id;

        private AddToTeamsRequestBuilder(List<String> teamKeys, String id) {
            this.teamKeys = teamKeys;
            this.id = id;
        }

        /**
         * Build call for addToTeams
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            MemberTeamsPostInput memberTeamsPostInput = buildBodyParams();
            return addToTeamsCall(id, memberTeamsPostInput, _callback);
        }

        private MemberTeamsPostInput buildBodyParams() {
            MemberTeamsPostInput memberTeamsPostInput = new MemberTeamsPostInput();
            memberTeamsPostInput.teamKeys(this.teamKeys);
            return memberTeamsPostInput;
        }

        /**
         * Execute addToTeams request
         * @return Member
         ...
         */
        public Member execute() throws ApiException {
            MemberTeamsPostInput memberTeamsPostInput = buildBodyParams();
            ApiResponse<Member> localVarResp = addToTeamsWithHttpInfo(id, memberTeamsPostInput);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute addToTeams request with HTTP info returned
         ...
         */
        public ApiResponse<Member> executeWithHttpInfo() throws ApiException {
            MemberTeamsPostInput memberTeamsPostInput = buildBodyParams();
            return addToTeamsWithHttpInfo(id, memberTeamsPostInput);
        }

        /**
         * Execute addToTeams request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Member> _callback) throws ApiException {
            MemberTeamsPostInput memberTeamsPostInput = buildBodyParams();
            return addToTeamsAsync(id, memberTeamsPostInput, _callback);
        }
    }
     ...
     * @return AddToTeamsRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Member response </td><td>  -  </td></tr>
     ...
     */
    public AddToTeamsRequestBuilder addToTeams(List<String> teamKeys, String id) throws IllegalArgumentException {
        if (teamKeys == null) throw new IllegalArgumentException("\"teamKeys\" is required but got null");
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new AddToTeamsRequestBuilder(teamKeys, id);
    }
    ...
    private ApiResponse<Member> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Member>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<Member> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public Member execute() throws ApiException {
            ApiResponse<Member> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private okhttp3.Call inviteNewMembersCall(List<NewMemberForm> newMemberForm, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call inviteNewMembersValidateBeforeCall(List<NewMemberForm> newMemberForm, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'newMemberForm' is set
        if (newMemberForm == null) {
            throw new ApiException("Missing the required parameter 'newMemberForm' when calling inviteNewMembers(Async)");
        }

        return inviteNewMembersCall(newMemberForm, _callback);

    }


    private ApiResponse<Members> inviteNewMembersWithHttpInfo(List<NewMemberForm> newMemberForm) throws ApiException {
        okhttp3.Call localVarCall = inviteNewMembersValidateBeforeCall(newMemberForm, null);
        Type localVarReturnType = new TypeToken<Members>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call inviteNewMembersAsync(List<NewMemberForm> newMemberForm, final ApiCallback<Members> _callback) throws ApiException {

        okhttp3.Call localVarCall = inviteNewMembersValidateBeforeCall(newMemberForm, _callback);
        Type localVarReturnType = new TypeToken<Members>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class InviteNewMembersRequestBuilder {
        private List<NewMemberForm> newMemberForm;

        private InviteNewMembersRequestBuilder() {
        }

        /**
         * Set newMemberForm
         * @param newMemberForm  (optional)
         * @return InviteNewMembersRequestBuilder
         */
        public InviteNewMembersRequestBuilder newMemberForm(List<NewMemberForm> newMemberForm) {
            this.newMemberForm = newMemberForm;
            return this;
        }

        /**
         * Build call for inviteNewMembers
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            List<NewMemberForm> newMemberForm = buildBodyParams();
            return inviteNewMembersCall(newMemberForm, _callback);
        }

        private List<NewMemberForm> buildBodyParams() {
            return this.newMemberForm;
        }

        /**
         * Execute inviteNewMembers request
         * @return Members
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public Members execute() throws ApiException {
            List<NewMemberForm> newMemberForm = buildBodyParams();
            ApiResponse<Members> localVarResp = inviteNewMembersWithHttpInfo(newMemberForm);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute inviteNewMembers request with HTTP info returned
         ...
         */
        public ApiResponse<Members> executeWithHttpInfo() throws ApiException {
            List<NewMemberForm> newMemberForm = buildBodyParams();
            return inviteNewMembersWithHttpInfo(newMemberForm);
        }

        /**
         * Execute inviteNewMembers request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Members> _callback) throws ApiException {
            List<NewMemberForm> newMemberForm = buildBodyParams();
            return inviteNewMembersAsync(newMemberForm, _callback);
        }
    }
     ...
     */
    public InviteNewMembersRequestBuilder inviteNewMembers() throws IllegalArgumentException {
        return new InviteNewMembersRequestBuilder();
    }
    private okhttp3.Call listMembersCall(Long limit, Long offset, String filter, String sort, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listMembersValidateBeforeCall(Long limit, Long offset, String filter, String sort, final ApiCallback _callback) throws ApiException {
        return listMembersCall(limit, offset, filter, sort, _callback);

    }


    private ApiResponse<Members> listMembersWithHttpInfo(Long limit, Long offset, String filter, String sort) throws ApiException {
        okhttp3.Call localVarCall = listMembersValidateBeforeCall(limit, offset, filter, sort, null);
        Type localVarReturnType = new TypeToken<Members>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listMembersAsync(Long limit, Long offset, String filter, String sort, final ApiCallback<Members> _callback) throws ApiException {

        okhttp3.Call localVarCall = listMembersValidateBeforeCall(limit, offset, filter, sort, _callback);
        Type localVarReturnType = new TypeToken<Members>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListMembersRequestBuilder {
         ...
         */
        public ListMembersRequestBuilder limit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListMembersRequestBuilder
         */
        public ListMembersRequestBuilder offset(Long offset) {
            this.offset = offset;
            return this;
        }
         ...
         * @return ListMembersRequestBuilder
         */
        public ListMembersRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return ListMembersRequestBuilder
         */
        public ListMembersRequestBuilder sort(String sort) {
            this.sort = sort;
            return this;
        }
         ...
         */
        public Members execute() throws ApiException {
            ApiResponse<Members> localVarResp = listMembersWithHttpInfo(limit, offset, filter, sort);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<Members> executeWithHttpInfo() throws ApiException {
            return listMembersWithHttpInfo(limit, offset, filter, sort);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Members> _callback) throws ApiException {
            return listMembersAsync(limit, offset, filter, sort, _callback);
        }
    }
    ...
    private okhttp3.Call updateMemberPatchCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateMemberPatchValidateBeforeCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateMemberPatch(Async)");
        }

        // verify the required parameter 'patchOperation' is set
        if (patchOperation == null) {
            throw new ApiException("Missing the required parameter 'patchOperation' when calling updateMemberPatch(Async)");
        }

        return updateMemberPatchCall(id, patchOperation, _callback);

    }


    private ApiResponse<Member> updateMemberPatchWithHttpInfo(String id, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = updateMemberPatchValidateBeforeCall(id, patchOperation, null);
        Type localVarReturnType = new TypeToken<Member>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateMemberPatchAsync(String id, List<PatchOperation> patchOperation, final ApiCallback<Member> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateMemberPatchValidateBeforeCall(id, patchOperation, _callback);
        Type localVarReturnType = new TypeToken<Member>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateMemberPatchRequestBuilder {
        private final String id;
        private List<PatchOperation> patchOperation;

        private UpdateMemberPatchRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * @return UpdateMemberPatchRequestBuilder
         */
        public UpdateMemberPatchRequestBuilder patchOperation(List<PatchOperation> patchOperation) {
            this.patchOperation = patchOperation;
            return this;
        }

        /**
         * Build call for updateMemberPatch
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute updateMemberPatch request
         * @return Member
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public Member execute() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            ApiResponse<Member> localVarResp = updateMemberPatchWithHttpInfo(id, patchOperation);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateMemberPatch request with HTTP info returned
         * @return ApiResponse&lt;Member&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<Member> executeWithHttpInfo() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateMemberPatchWithHttpInfo(id, patchOperation);
        }

        /**
         * Execute updateMemberPatch request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Member> _callback) throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateMemberPatchAsync(id, patchOperation, _callback);
        }
    }
     ...
     */
    public UpdateMemberPatchRequestBuilder updateMemberPatch(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateMemberPatchRequestBuilder(id);
    }
}
