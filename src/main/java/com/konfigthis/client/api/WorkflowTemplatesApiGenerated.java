...
import com.konfigthis.client.model.CreateWorkflowTemplateInput;
import com.konfigthis.client.model.StageInput;
import com.konfigthis.client.model.WorkflowTemplateOutput;
import com.konfigthis.client.model.WorkflowTemplatesListingOutputRep;
...
public class WorkflowTemplatesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WorkflowTemplatesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public WorkflowTemplatesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createFeatureFlagTemplateCall(CreateWorkflowTemplateInput createWorkflowTemplateInput, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createFeatureFlagTemplateValidateBeforeCall(CreateWorkflowTemplateInput createWorkflowTemplateInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'createWorkflowTemplateInput' is set
        if (createWorkflowTemplateInput == null) {
            throw new ApiException("Missing the required parameter 'createWorkflowTemplateInput' when calling createFeatureFlagTemplate(Async)");
        }

        return createFeatureFlagTemplateCall(createWorkflowTemplateInput, _callback);

    }


    private ApiResponse<WorkflowTemplateOutput> createFeatureFlagTemplateWithHttpInfo(CreateWorkflowTemplateInput createWorkflowTemplateInput) throws ApiException {
        okhttp3.Call localVarCall = createFeatureFlagTemplateValidateBeforeCall(createWorkflowTemplateInput, null);
        Type localVarReturnType = new TypeToken<WorkflowTemplateOutput>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createFeatureFlagTemplateAsync(CreateWorkflowTemplateInput createWorkflowTemplateInput, final ApiCallback<WorkflowTemplateOutput> _callback) throws ApiException {

        okhttp3.Call localVarCall = createFeatureFlagTemplateValidateBeforeCall(createWorkflowTemplateInput, _callback);
        Type localVarReturnType = new TypeToken<WorkflowTemplateOutput>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateFeatureFlagTemplateRequestBuilder {
        ...
        private CreateFeatureFlagTemplateRequestBuilder(String key) {
            this.key = key;
        }
         ...
         * @return CreateFeatureFlagTemplateRequestBuilder
         */
        public CreateFeatureFlagTemplateRequestBuilder description(String description) {
         ...
         * @return CreateFeatureFlagTemplateRequestBuilder
         */
        public CreateFeatureFlagTemplateRequestBuilder name(String name) {
            this.name = name;
            return this;
        }
         ...
         * @return CreateFeatureFlagTemplateRequestBuilder
         */
        public CreateFeatureFlagTemplateRequestBuilder workflowId(String workflowId) {
         ...
         * @return CreateFeatureFlagTemplateRequestBuilder
         */
        public CreateFeatureFlagTemplateRequestBuilder stages(List<StageInput> stages) {
            this.stages = stages;
            return this;
        }
         ...
         * @return CreateFeatureFlagTemplateRequestBuilder
         */
        public CreateFeatureFlagTemplateRequestBuilder projectKey(String projectKey) {
        ...
        /**
         * Set environmentKey
         * @param environmentKey  (optional)
         * @return CreateFeatureFlagTemplateRequestBuilder
         */
        public CreateFeatureFlagTemplateRequestBuilder environmentKey(String environmentKey) {
        ...
        /**
         * Set flagKey
         * @param flagKey  (optional)
         * @return CreateFeatureFlagTemplateRequestBuilder
         */
        public CreateFeatureFlagTemplateRequestBuilder flagKey(String flagKey) {
            this.flagKey = flagKey;
            return this;
        }
        
        /**
         * Build call for createFeatureFlagTemplate
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            CreateWorkflowTemplateInput createWorkflowTemplateInput = buildBodyParams();
            return createFeatureFlagTemplateCall(createWorkflowTemplateInput, _callback);
        }

        private CreateWorkflowTemplateInput buildBodyParams() {
            CreateWorkflowTemplateInput createWorkflowTemplateInput = new CreateWorkflowTemplateInput();
            createWorkflowTemplateInput.description(this.description);
            createWorkflowTemplateInput.key(this.key);
            createWorkflowTemplateInput.name(this.name);
            createWorkflowTemplateInput.workflowId(this.workflowId);
            createWorkflowTemplateInput.stages(this.stages);
            createWorkflowTemplateInput.projectKey(this.projectKey);
            createWorkflowTemplateInput.environmentKey(this.environmentKey);
            createWorkflowTemplateInput.flagKey(this.flagKey);
            return createWorkflowTemplateInput;
        }

        /**
         * Execute createFeatureFlagTemplate request
         ...
         */
        public WorkflowTemplateOutput execute() throws ApiException {
            CreateWorkflowTemplateInput createWorkflowTemplateInput = buildBodyParams();
            ApiResponse<WorkflowTemplateOutput> localVarResp = createFeatureFlagTemplateWithHttpInfo(createWorkflowTemplateInput);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createFeatureFlagTemplate request with HTTP info returned
         ...
         */
        public ApiResponse<WorkflowTemplateOutput> executeWithHttpInfo() throws ApiException {
            CreateWorkflowTemplateInput createWorkflowTemplateInput = buildBodyParams();
            return createFeatureFlagTemplateWithHttpInfo(createWorkflowTemplateInput);
        }

        /**
         * Execute createFeatureFlagTemplate request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<WorkflowTemplateOutput> _callback) throws ApiException {
            CreateWorkflowTemplateInput createWorkflowTemplateInput = buildBodyParams();
            return createFeatureFlagTemplateAsync(createWorkflowTemplateInput, _callback);
        }
    }
     ...
     */
    public CreateFeatureFlagTemplateRequestBuilder createFeatureFlagTemplate(String key) throws IllegalArgumentException {
        if (key == null) throw new IllegalArgumentException("\"key\" is required but got null");
            

        return new CreateFeatureFlagTemplateRequestBuilder(key);
    }
    private okhttp3.Call deleteTemplateCall(String templateKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTemplateValidateBeforeCall(String templateKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'templateKey' is set
        if (templateKey == null) {
            throw new ApiException("Missing the required parameter 'templateKey' when calling deleteTemplate(Async)");
        }

        return deleteTemplateCall(templateKey, _callback);

    }


    private ApiResponse<Void> deleteTemplateWithHttpInfo(String templateKey) throws ApiException {
        okhttp3.Call localVarCall = deleteTemplateValidateBeforeCall(templateKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteTemplateAsync(String templateKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteTemplateValidateBeforeCall(templateKey, _callback);
    ...
    public class DeleteTemplateRequestBuilder {
        ...
        private DeleteTemplateRequestBuilder(String templateKey) {
        ...
        public void execute() throws ApiException {
            deleteTemplateWithHttpInfo(templateKey);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteTemplateWithHttpInfo(templateKey);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteTemplateAsync(templateKey, _callback);
        }
    }
     ...
     */
    public DeleteTemplateRequestBuilder deleteTemplate(String templateKey) throws IllegalArgumentException {
        if (templateKey == null) throw new IllegalArgumentException("\"templateKey\" is required but got null");
            

        return new DeleteTemplateRequestBuilder(templateKey);
    }
    private okhttp3.Call listCall(Boolean summary, String search, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Boolean summary, String search, final ApiCallback _callback) throws ApiException {
        return listCall(summary, search, _callback);

    }


    private ApiResponse<WorkflowTemplatesListingOutputRep> listWithHttpInfo(Boolean summary, String search) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(summary, search, null);
        Type localVarReturnType = new TypeToken<WorkflowTemplatesListingOutputRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Boolean summary, String search, final ApiCallback<WorkflowTemplatesListingOutputRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(summary, search, _callback);
        Type localVarReturnType = new TypeToken<WorkflowTemplatesListingOutputRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
         ...
         */
        public WorkflowTemplatesListingOutputRep execute() throws ApiException {
            ApiResponse<WorkflowTemplatesListingOutputRep> localVarResp = listWithHttpInfo(summary, search);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<WorkflowTemplatesListingOutputRep> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(summary, search);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<WorkflowTemplatesListingOutputRep> _callback) throws ApiException {
            return listAsync(summary, search, _callback);
        }
    }
