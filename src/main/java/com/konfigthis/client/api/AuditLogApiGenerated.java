...
import com.konfigthis.client.model.AuditLogEntryListingRepCollection;
import com.konfigthis.client.model.AuditLogEntryRep;
...
public class AuditLogApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AuditLogApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AuditLogApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call detailEntryCall(String id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call detailEntryValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling detailEntry(Async)");
        }

        return detailEntryCall(id, _callback);

    }


    private ApiResponse<AuditLogEntryRep> detailEntryWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = detailEntryValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<AuditLogEntryRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call detailEntryAsync(String id, final ApiCallback<AuditLogEntryRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = detailEntryValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<AuditLogEntryRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class DetailEntryRequestBuilder {
        private final String id;

        private DetailEntryRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for detailEntry
         ...
         */
        public AuditLogEntryRep execute() throws ApiException {
            ApiResponse<AuditLogEntryRep> localVarResp = detailEntryWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute detailEntry request with HTTP info returned
         ...
         */
        public ApiResponse<AuditLogEntryRep> executeWithHttpInfo() throws ApiException {
            return detailEntryWithHttpInfo(id);
        }

        /**
         * Execute detailEntry request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<AuditLogEntryRep> _callback) throws ApiException {
            return detailEntryAsync(id, _callback);
        }
    }
     ...
     * @return DetailEntryRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Audit log entry response </td><td>  -  </td></tr>
     ...
     */
    public DetailEntryRequestBuilder detailEntry(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new DetailEntryRequestBuilder(id);
    }
    private okhttp3.Call listAuditLogEntriesCall(Long before, Long after, String q, Long limit, String spec, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAuditLogEntriesValidateBeforeCall(Long before, Long after, String q, Long limit, String spec, final ApiCallback _callback) throws ApiException {
        return listAuditLogEntriesCall(before, after, q, limit, spec, _callback);

    }


    private ApiResponse<AuditLogEntryListingRepCollection> listAuditLogEntriesWithHttpInfo(Long before, Long after, String q, Long limit, String spec) throws ApiException {
        okhttp3.Call localVarCall = listAuditLogEntriesValidateBeforeCall(before, after, q, limit, spec, null);
        Type localVarReturnType = new TypeToken<AuditLogEntryListingRepCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAuditLogEntriesAsync(Long before, Long after, String q, Long limit, String spec, final ApiCallback<AuditLogEntryListingRepCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAuditLogEntriesValidateBeforeCall(before, after, q, limit, spec, _callback);
        Type localVarReturnType = new TypeToken<AuditLogEntryListingRepCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListAuditLogEntriesRequestBuilder {
        private Long before;
        private Long after;
        private String q;
        private Long limit;
        ...
        private ListAuditLogEntriesRequestBuilder() {
        }
         ...
         * @return ListAuditLogEntriesRequestBuilder
         */
        public ListAuditLogEntriesRequestBuilder before(Long before) {
            this.before = before;
            return this;
        }
         ...
         * @return ListAuditLogEntriesRequestBuilder
         */
        public ListAuditLogEntriesRequestBuilder after(Long after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListAuditLogEntriesRequestBuilder
         */
        public ListAuditLogEntriesRequestBuilder q(String q) {
            this.q = q;
            return this;
        }
         ...
         * @return ListAuditLogEntriesRequestBuilder
         */
        public ListAuditLogEntriesRequestBuilder limit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListAuditLogEntriesRequestBuilder
         */
        public ListAuditLogEntriesRequestBuilder spec(String spec) {
            this.spec = spec;
            return this;
        }
        
        /**
         * Build call for listAuditLogEntries
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listAuditLogEntries request
         ...
         */
        public AuditLogEntryListingRepCollection execute() throws ApiException {
            ApiResponse<AuditLogEntryListingRepCollection> localVarResp = listAuditLogEntriesWithHttpInfo(before, after, q, limit, spec);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listAuditLogEntries request with HTTP info returned
         ...
         */
        public ApiResponse<AuditLogEntryListingRepCollection> executeWithHttpInfo() throws ApiException {
            return listAuditLogEntriesWithHttpInfo(before, after, q, limit, spec);
        }

        /**
         * Execute listAuditLogEntries request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<AuditLogEntryListingRepCollection> _callback) throws ApiException {
            return listAuditLogEntriesAsync(before, after, q, limit, spec, _callback);
        }
    }
     ...
     */
    public ListAuditLogEntriesRequestBuilder listAuditLogEntries() throws IllegalArgumentException {
        return new ListAuditLogEntriesRequestBuilder();
    }
}
