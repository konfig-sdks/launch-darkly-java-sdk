...
import com.konfigthis.client.model.BulkEditMembersRep;
import com.konfigthis.client.model.MembersPatchInput;
...
public class AccountMembersBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AccountMembersBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AccountMembersBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call modifyMembersRolesCall(MembersPatchInput membersPatchInput, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call modifyMembersRolesValidateBeforeCall(MembersPatchInput membersPatchInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'membersPatchInput' is set
        if (membersPatchInput == null) {
            throw new ApiException("Missing the required parameter 'membersPatchInput' when calling modifyMembersRoles(Async)");
        }

        return modifyMembersRolesCall(membersPatchInput, _callback);

    }


    private ApiResponse<BulkEditMembersRep> modifyMembersRolesWithHttpInfo(MembersPatchInput membersPatchInput) throws ApiException {
        okhttp3.Call localVarCall = modifyMembersRolesValidateBeforeCall(membersPatchInput, null);
        Type localVarReturnType = new TypeToken<BulkEditMembersRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call modifyMembersRolesAsync(MembersPatchInput membersPatchInput, final ApiCallback<BulkEditMembersRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = modifyMembersRolesValidateBeforeCall(membersPatchInput, _callback);
        Type localVarReturnType = new TypeToken<BulkEditMembersRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ModifyMembersRolesRequestBuilder {
        private final List<Map<String, Object>> instructions;
        private String comment;

        private ModifyMembersRolesRequestBuilder(List<Map<String, Object>> instructions) {
         ...
         * @return ModifyMembersRolesRequestBuilder
         */
        public ModifyMembersRolesRequestBuilder comment(String comment) {
            this.comment = comment;
            return this;
        }
        
        /**
         * Build call for modifyMembersRoles
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            MembersPatchInput membersPatchInput = buildBodyParams();
            return modifyMembersRolesCall(membersPatchInput, _callback);
        }

        private MembersPatchInput buildBodyParams() {
            MembersPatchInput membersPatchInput = new MembersPatchInput();
            membersPatchInput.comment(this.comment);
            membersPatchInput.instructions(this.instructions);
            return membersPatchInput;
        }

        /**
         * Execute modifyMembersRoles request
         ...
         */
        public BulkEditMembersRep execute() throws ApiException {
            MembersPatchInput membersPatchInput = buildBodyParams();
            ApiResponse<BulkEditMembersRep> localVarResp = modifyMembersRolesWithHttpInfo(membersPatchInput);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute modifyMembersRoles request with HTTP info returned
         ...
         */
        public ApiResponse<BulkEditMembersRep> executeWithHttpInfo() throws ApiException {
            MembersPatchInput membersPatchInput = buildBodyParams();
            return modifyMembersRolesWithHttpInfo(membersPatchInput);
        }

        /**
         * Execute modifyMembersRoles request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<BulkEditMembersRep> _callback) throws ApiException {
            MembersPatchInput membersPatchInput = buildBodyParams();
            return modifyMembersRolesAsync(membersPatchInput, _callback);
        }
    }
     ...
     */
    public ModifyMembersRolesRequestBuilder modifyMembersRoles(List<Map<String, Object>> instructions) throws IllegalArgumentException {
        if (instructions == null) throw new IllegalArgumentException("\"instructions\" is required but got null");
        return new ModifyMembersRolesRequestBuilder(instructions);
    }
}
