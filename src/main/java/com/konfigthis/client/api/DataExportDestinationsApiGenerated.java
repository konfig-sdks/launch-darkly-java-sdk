...
import com.konfigthis.client.model.Destination;
import com.konfigthis.client.model.DestinationPost;
import com.konfigthis.client.model.Destinations;
...
public class DataExportDestinationsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DataExportDestinationsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public DataExportDestinationsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createDestinationCall(String projectKey, String environmentKey, DestinationPost destinationPost, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createDestinationValidateBeforeCall(String projectKey, String environmentKey, DestinationPost destinationPost, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling createDestination(Async)");
        }

        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling createDestination(Async)");
        }

        // verify the required parameter 'destinationPost' is set
        if (destinationPost == null) {
            throw new ApiException("Missing the required parameter 'destinationPost' when calling createDestination(Async)");
        }

        return createDestinationCall(projectKey, environmentKey, destinationPost, _callback);

    }


    private ApiResponse<Destination> createDestinationWithHttpInfo(String projectKey, String environmentKey, DestinationPost destinationPost) throws ApiException {
        okhttp3.Call localVarCall = createDestinationValidateBeforeCall(projectKey, environmentKey, destinationPost, null);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createDestinationAsync(String projectKey, String environmentKey, DestinationPost destinationPost, final ApiCallback<Destination> _callback) throws ApiException {

        okhttp3.Call localVarCall = createDestinationValidateBeforeCall(projectKey, environmentKey, destinationPost, _callback);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
    ...
    public class CreateDestinationRequestBuilder {
        ...
        private CreateDestinationRequestBuilder(String projectKey, String environmentKey) {
        ...
        /**
         * Set name
         * @param name A human-readable name for your Data Export destination (optional)
         * @return CreateDestinationRequestBuilder
         */
        public CreateDestinationRequestBuilder name(String name) {
            this.name = name;
            return this;
        }
        ...
        /**
         * Set kind
         * @param kind The type of Data Export destination (optional)
         * @return CreateDestinationRequestBuilder
         */
        public CreateDestinationRequestBuilder kind(String kind) {
            this.kind = kind;
            return this;
        }
        ...
        /**
         * Set config
         * @param config An object with the configuration parameters required for the destination type (optional)
         * @return CreateDestinationRequestBuilder
         */
        public CreateDestinationRequestBuilder config(Object config) {
            this.config = config;
            return this;
        }
        ...
        /**
         * Set true
         * @param true Whether the export is on. Displayed as the integration status in the LaunchDarkly UI. (optional)
         * @return CreateDestinationRequestBuilder
         */
        public CreateDestinationRequestBuilder true(Boolean true) {
            this.true = true;
            return this;
        }
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            DestinationPost destinationPost = buildBodyParams();
            return createDestinationCall(projectKey, environmentKey, destinationPost, _callback);
        }

        private DestinationPost buildBodyParams() {
            DestinationPost destinationPost = new DestinationPost();
            destinationPost.name(this.name);
            if (this.kind != null)
            destinationPost.kind(DestinationPost.KindEnum.fromValue(this.kind));
            destinationPost.config(this.config);
            destinationPost.true(this.true);
        ...
        public Destination execute() throws ApiException {
            DestinationPost destinationPost = buildBodyParams();
            ApiResponse<Destination> localVarResp = createDestinationWithHttpInfo(projectKey, environmentKey, destinationPost);
         ...
         */
        public ApiResponse<Destination> executeWithHttpInfo() throws ApiException {
            DestinationPost destinationPost = buildBodyParams();
            return createDestinationWithHttpInfo(projectKey, environmentKey, destinationPost);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Destination> _callback) throws ApiException {
            DestinationPost destinationPost = buildBodyParams();
            return createDestinationAsync(projectKey, environmentKey, destinationPost, _callback);
        }
    }
     ...
     */
    public CreateDestinationRequestBuilder createDestination(String projectKey, String environmentKey) throws IllegalArgumentException {
        ...
        return new CreateDestinationRequestBuilder(projectKey, environmentKey);
    }
    private okhttp3.Call deleteByIdCall(String projectKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteByIdValidateBeforeCall(String projectKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
        ...
        return deleteByIdCall(projectKey, environmentKey, id, _callback);

    }


    private ApiResponse<Void> deleteByIdWithHttpInfo(String projectKey, String environmentKey, String id) throws ApiException {
        okhttp3.Call localVarCall = deleteByIdValidateBeforeCall(projectKey, environmentKey, id, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteByIdAsync(String projectKey, String environmentKey, String id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteByIdValidateBeforeCall(projectKey, environmentKey, id, _callback);
    ...
    public class DeleteByIdRequestBuilder {
        ...
        private DeleteByIdRequestBuilder(String projectKey, String environmentKey, String id) {
            this.projectKey = projectKey;
            this.environmentKey = environmentKey;
            this.id = id;
        }
        ...
        public void execute() throws ApiException {
            deleteByIdWithHttpInfo(projectKey, environmentKey, id);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteByIdWithHttpInfo(projectKey, environmentKey, id);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteByIdAsync(projectKey, environmentKey, id, _callback);
        }
    }
     ...
     */
    public DeleteByIdRequestBuilder deleteById(String projectKey, String environmentKey, String id) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
        ...
        return new DeleteByIdRequestBuilder(projectKey, environmentKey, id);
    }
    ...
    private ApiResponse<Destinations> getAllWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAllValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Destinations>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAllAsync(final ApiCallback<Destinations> _callback) throws ApiException {
    ...
    public class GetAllRequestBuilder {
         ...
         */
        public Destinations execute() throws ApiException {
            ApiResponse<Destinations> localVarResp = getAllWithHttpInfo();
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<Destinations> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Destinations> _callback) throws ApiException {
    ...
    private okhttp3.Call getSingleByIdCall(String projectKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSingleByIdValidateBeforeCall(String projectKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getSingleById(Async)");
        }

        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getSingleById(Async)");
        }
        ...
        return getSingleByIdCall(projectKey, environmentKey, id, _callback);

    }


    private ApiResponse<Destination> getSingleByIdWithHttpInfo(String projectKey, String environmentKey, String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleByIdValidateBeforeCall(projectKey, environmentKey, id, null);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleByIdAsync(String projectKey, String environmentKey, String id, final ApiCallback<Destination> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSingleByIdValidateBeforeCall(projectKey, environmentKey, id, _callback);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetSingleByIdRequestBuilder {
        ...
        private GetSingleByIdRequestBuilder(String projectKey, String environmentKey, String id) {
            this.projectKey = projectKey;
            this.environmentKey = environmentKey;
            this.id = id;
        }
         ...
         */
        public Destination execute() throws ApiException {
            ApiResponse<Destination> localVarResp = getSingleByIdWithHttpInfo(projectKey, environmentKey, id);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<Destination> executeWithHttpInfo() throws ApiException {
            return getSingleByIdWithHttpInfo(projectKey, environmentKey, id);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Destination> _callback) throws ApiException {
            return getSingleByIdAsync(projectKey, environmentKey, id, _callback);
        }
    }
     ...
     */
    public GetSingleByIdRequestBuilder getSingleById(String projectKey, String environmentKey, String id) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
        ...
        return new GetSingleByIdRequestBuilder(projectKey, environmentKey, id);
    }
    private okhttp3.Call updateDestinationPatchCall(String projectKey, String environmentKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateDestinationPatchValidateBeforeCall(String projectKey, String environmentKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling updateDestinationPatch(Async)");
        }

        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling updateDestinationPatch(Async)");
        }

        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateDestinationPatch(Async)");
        }

        // verify the required parameter 'patchOperation' is set
        if (patchOperation == null) {
            throw new ApiException("Missing the required parameter 'patchOperation' when calling updateDestinationPatch(Async)");
        }

        return updateDestinationPatchCall(projectKey, environmentKey, id, patchOperation, _callback);

    }


    private ApiResponse<Destination> updateDestinationPatchWithHttpInfo(String projectKey, String environmentKey, String id, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = updateDestinationPatchValidateBeforeCall(projectKey, environmentKey, id, patchOperation, null);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateDestinationPatchAsync(String projectKey, String environmentKey, String id, List<PatchOperation> patchOperation, final ApiCallback<Destination> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateDestinationPatchValidateBeforeCall(projectKey, environmentKey, id, patchOperation, _callback);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateDestinationPatchRequestBuilder {
        private final String projectKey;
        private final String environmentKey;
        private final String id;
        private List<PatchOperation> patchOperation;

        private UpdateDestinationPatchRequestBuilder(String projectKey, String environmentKey, String id) {
            this.projectKey = projectKey;
            this.environmentKey = environmentKey;
            this.id = id;
        }
         ...
         * @return UpdateDestinationPatchRequestBuilder
         */
        public UpdateDestinationPatchRequestBuilder patchOperation(List<PatchOperation> patchOperation) {
            this.patchOperation = patchOperation;
            return this;
        }

        /**
         * Build call for updateDestinationPatch
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute updateDestinationPatch request
         * @return Destination
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public Destination execute() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            ApiResponse<Destination> localVarResp = updateDestinationPatchWithHttpInfo(projectKey, environmentKey, id, patchOperation);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateDestinationPatch request with HTTP info returned
         * @return ApiResponse&lt;Destination&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<Destination> executeWithHttpInfo() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateDestinationPatchWithHttpInfo(projectKey, environmentKey, id, patchOperation);
        }

        /**
         * Execute updateDestinationPatch request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Destination> _callback) throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateDestinationPatchAsync(projectKey, environmentKey, id, patchOperation, _callback);
        }
    }
     ...
     */
    public UpdateDestinationPatchRequestBuilder updateDestinationPatch(String projectKey, String environmentKey, String id) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
        ...
        return new UpdateDestinationPatchRequestBuilder(projectKey, environmentKey, id);
    }
}
