...
import com.konfigthis.client.model.RelayAutoConfigCollectionRep;
import com.konfigthis.client.model.RelayAutoConfigPost;
import com.konfigthis.client.model.RelayAutoConfigRep;
...
public class RelayProxyConfigurationsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RelayProxyConfigurationsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RelayProxyConfigurationsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewConfigCall(RelayAutoConfigPost relayAutoConfigPost, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNewConfigValidateBeforeCall(RelayAutoConfigPost relayAutoConfigPost, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'relayAutoConfigPost' is set
        if (relayAutoConfigPost == null) {
            throw new ApiException("Missing the required parameter 'relayAutoConfigPost' when calling createNewConfig(Async)");
        }

        return createNewConfigCall(relayAutoConfigPost, _callback);

    }


    private ApiResponse<RelayAutoConfigRep> createNewConfigWithHttpInfo(RelayAutoConfigPost relayAutoConfigPost) throws ApiException {
        okhttp3.Call localVarCall = createNewConfigValidateBeforeCall(relayAutoConfigPost, null);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewConfigAsync(RelayAutoConfigPost relayAutoConfigPost, final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewConfigValidateBeforeCall(relayAutoConfigPost, _callback);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
    ...
    public class CreateNewConfigRequestBuilder {
        ...
        private final List<Statement> policy;

        private CreateNewConfigRequestBuilder(String name, List<Statement> policy) {
            this.name = name;
            this.policy = policy;
        }
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            RelayAutoConfigPost relayAutoConfigPost = buildBodyParams();
            return createNewConfigCall(relayAutoConfigPost, _callback);
        }

        private RelayAutoConfigPost buildBodyParams() {
            RelayAutoConfigPost relayAutoConfigPost = new RelayAutoConfigPost();
            relayAutoConfigPost.name(this.name);
            relayAutoConfigPost.policy(this.policy);
            return relayAutoConfigPost;
        }
         ...
         */
        public RelayAutoConfigRep execute() throws ApiException {
            RelayAutoConfigPost relayAutoConfigPost = buildBodyParams();
            ApiResponse<RelayAutoConfigRep> localVarResp = createNewConfigWithHttpInfo(relayAutoConfigPost);
         ...
         */
        public ApiResponse<RelayAutoConfigRep> executeWithHttpInfo() throws ApiException {
            RelayAutoConfigPost relayAutoConfigPost = buildBodyParams();
            return createNewConfigWithHttpInfo(relayAutoConfigPost);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {
            RelayAutoConfigPost relayAutoConfigPost = buildBodyParams();
            return createNewConfigAsync(relayAutoConfigPost, _callback);
        }
    }
     ...
     */
    public CreateNewConfigRequestBuilder createNewConfig(String name, List<Statement> policy) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("\"name\" is required but got null");
            

        if (policy == null) throw new IllegalArgumentException("\"policy\" is required but got null");
        return new CreateNewConfigRequestBuilder(name, policy);
    }
    ...
    private okhttp3.Call getSingleByIdCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSingleByIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getSingleById(Async)");
        }

        return getSingleByIdCall(id, _callback);

    }


    private ApiResponse<RelayAutoConfigRep> getSingleByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleByIdAsync(String id, final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSingleByIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetSingleByIdRequestBuilder {
         ...
         */
        public RelayAutoConfigRep execute() throws ApiException {
            ApiResponse<RelayAutoConfigRep> localVarResp = getSingleByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<RelayAutoConfigRep> executeWithHttpInfo() throws ApiException {
            return getSingleByIdWithHttpInfo(id);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {
            return getSingleByIdAsync(id, _callback);
        }
    }
    ...
    private ApiResponse<RelayAutoConfigCollectionRep> listWithHttpInfo() throws ApiException {
    ...
    private okhttp3.Call listAsync(final ApiCallback<RelayAutoConfigCollectionRep> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         */
        public RelayAutoConfigCollectionRep execute() throws ApiException {
            ApiResponse<RelayAutoConfigCollectionRep> localVarResp = listWithHttpInfo();
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<RelayAutoConfigCollectionRep> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RelayAutoConfigCollectionRep> _callback) throws ApiException {
    ...
    private okhttp3.Call resetSecretKeyWithExpiryCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resetSecretKeyWithExpiryValidateBeforeCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling resetSecretKeyWithExpiry(Async)");
        }

        return resetSecretKeyWithExpiryCall(id, expiry, _callback);

    }


    private ApiResponse<RelayAutoConfigRep> resetSecretKeyWithExpiryWithHttpInfo(String id, Long expiry) throws ApiException {
        okhttp3.Call localVarCall = resetSecretKeyWithExpiryValidateBeforeCall(id, expiry, null);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call resetSecretKeyWithExpiryAsync(String id, Long expiry, final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = resetSecretKeyWithExpiryValidateBeforeCall(id, expiry, _callback);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ResetSecretKeyWithExpiryRequestBuilder {
        private final String id;
        private Long expiry;

        private ResetSecretKeyWithExpiryRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * @return ResetSecretKeyWithExpiryRequestBuilder
         */
        public ResetSecretKeyWithExpiryRequestBuilder expiry(Long expiry) {
            this.expiry = expiry;
            return this;
        }
        
        /**
         * Build call for resetSecretKeyWithExpiry
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute resetSecretKeyWithExpiry request
         * @return RelayAutoConfigRep
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public RelayAutoConfigRep execute() throws ApiException {
            ApiResponse<RelayAutoConfigRep> localVarResp = resetSecretKeyWithExpiryWithHttpInfo(id, expiry);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute resetSecretKeyWithExpiry request with HTTP info returned
         * @return ApiResponse&lt;RelayAutoConfigRep&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<RelayAutoConfigRep> executeWithHttpInfo() throws ApiException {
            return resetSecretKeyWithExpiryWithHttpInfo(id, expiry);
        }

        /**
         * Execute resetSecretKeyWithExpiry request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {
            return resetSecretKeyWithExpiryAsync(id, expiry, _callback);
        }
    }
     ...
     */
    public ResetSecretKeyWithExpiryRequestBuilder resetSecretKeyWithExpiry(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new ResetSecretKeyWithExpiryRequestBuilder(id);
    }
    private okhttp3.Call updateConfigPatchCall(String id, PatchWithComment patchWithComment, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateConfigPatchValidateBeforeCall(String id, PatchWithComment patchWithComment, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateConfigPatch(Async)");
        }

        // verify the required parameter 'patchWithComment' is set
        if (patchWithComment == null) {
            throw new ApiException("Missing the required parameter 'patchWithComment' when calling updateConfigPatch(Async)");
        }

        return updateConfigPatchCall(id, patchWithComment, _callback);

    }


    private ApiResponse<RelayAutoConfigRep> updateConfigPatchWithHttpInfo(String id, PatchWithComment patchWithComment) throws ApiException {
        okhttp3.Call localVarCall = updateConfigPatchValidateBeforeCall(id, patchWithComment, null);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateConfigPatchAsync(String id, PatchWithComment patchWithComment, final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateConfigPatchValidateBeforeCall(id, patchWithComment, _callback);
        Type localVarReturnType = new TypeToken<RelayAutoConfigRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateConfigPatchRequestBuilder {
        private final List<PatchOperation> patch;
        private final String id;
        private String comment;

        private UpdateConfigPatchRequestBuilder(List<PatchOperation> patch, String id) {
            this.patch = patch;
            this.id = id;
        }
         ...
         * @return UpdateConfigPatchRequestBuilder
         */
        public UpdateConfigPatchRequestBuilder comment(String comment) {
            this.comment = comment;
            return this;
        }
        
        /**
         * Build call for updateConfigPatch
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute updateConfigPatch request
         * @return RelayAutoConfigRep
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public RelayAutoConfigRep execute() throws ApiException {
            PatchWithComment patchWithComment = buildBodyParams();
            ApiResponse<RelayAutoConfigRep> localVarResp = updateConfigPatchWithHttpInfo(id, patchWithComment);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateConfigPatch request with HTTP info returned
         * @return ApiResponse&lt;RelayAutoConfigRep&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<RelayAutoConfigRep> executeWithHttpInfo() throws ApiException {
            PatchWithComment patchWithComment = buildBodyParams();
            return updateConfigPatchWithHttpInfo(id, patchWithComment);
        }

        /**
         * Execute updateConfigPatch request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<RelayAutoConfigRep> _callback) throws ApiException {
            PatchWithComment patchWithComment = buildBodyParams();
            return updateConfigPatchAsync(id, patchWithComment, _callback);
        }
    }
     ...
     */
    public UpdateConfigPatchRequestBuilder updateConfigPatch(List<PatchOperation> patch, String id) throws IllegalArgumentException {
        if (patch == null) throw new IllegalArgumentException("\"patch\" is required but got null");
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateConfigPatchRequestBuilder(patch, id);
    }
}
