...
import com.konfigthis.client.model.AccessTokenPost;
...
import com.konfigthis.client.model.Tokens;
...
public class AccessTokensApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AccessTokensApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AccessTokensApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewTokenCall(AccessTokenPost accessTokenPost, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNewTokenValidateBeforeCall(AccessTokenPost accessTokenPost, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accessTokenPost' is set
        if (accessTokenPost == null) {
            throw new ApiException("Missing the required parameter 'accessTokenPost' when calling createNewToken(Async)");
        }

        return createNewTokenCall(accessTokenPost, _callback);

    }


    private ApiResponse<Token> createNewTokenWithHttpInfo(AccessTokenPost accessTokenPost) throws ApiException {
        okhttp3.Call localVarCall = createNewTokenValidateBeforeCall(accessTokenPost, null);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewTokenAsync(AccessTokenPost accessTokenPost, final ApiCallback<Token> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewTokenValidateBeforeCall(accessTokenPost, _callback);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewTokenRequestBuilder {
        private String description;
        private String name;
        private String role;
        private List<String> customRoleIds;
        private List<StatementPost> inlineRole;
        private Boolean serviceToken;
        private Integer defaultApiVersion;

        private CreateNewTokenRequestBuilder() {
        }

        /**
         * Set description
         * @param description A description for the access token (optional)
         * @return CreateNewTokenRequestBuilder
         */
        public CreateNewTokenRequestBuilder description(String description) {
        ...
        /**
         * Set name
         * @param name A human-friendly name for the access token (optional)
         * @return CreateNewTokenRequestBuilder
         */
        public CreateNewTokenRequestBuilder name(String name) {
            this.name = name;
            return this;
        }
        ...
        /**
         * Set role
         * @param role Built-in role for the token (optional)
         * @return CreateNewTokenRequestBuilder
         */
        public CreateNewTokenRequestBuilder role(String role) {
            this.role = role;
            return this;
        }
        ...
        /**
         * Set customRoleIds
         * @param customRoleIds A list of custom role IDs to use as access limits for the access token (optional)
         * @return CreateNewTokenRequestBuilder
         */
        public CreateNewTokenRequestBuilder customRoleIds(List<String> customRoleIds) {
        ...
        /**
         * Set inlineRole
         * @param inlineRole A JSON array of statements represented as JSON objects with three attributes: effect, resources, actions. May be used in place of a built-in or custom role. (optional)
         * @return CreateNewTokenRequestBuilder
         */
        public CreateNewTokenRequestBuilder inlineRole(List<StatementPost> inlineRole) {
        ...
        /**
         * Set serviceToken
         * @param serviceToken Whether the token is a service token https://docs.launchdarkly.com/home/account-security/api-access-tokens#service-tokens (optional)
         * @return CreateNewTokenRequestBuilder
         */
        public CreateNewTokenRequestBuilder serviceToken(Boolean serviceToken) {
            this.serviceToken = serviceToken;
            return this;
        }
        
        /**
         * Set defaultApiVersion
         * @param defaultApiVersion The default API version for this token (optional)
         * @return CreateNewTokenRequestBuilder
         */
        public CreateNewTokenRequestBuilder defaultApiVersion(Integer defaultApiVersion) {
            this.defaultApiVersion = defaultApiVersion;
            return this;
        }
        
        /**
         * Build call for createNewToken
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            AccessTokenPost accessTokenPost = buildBodyParams();
            return createNewTokenCall(accessTokenPost, _callback);
        }

        private AccessTokenPost buildBodyParams() {
            AccessTokenPost accessTokenPost = new AccessTokenPost();
            accessTokenPost.description(this.description);
            accessTokenPost.name(this.name);
            if (this.role != null)
            accessTokenPost.role(AccessTokenPost.RoleEnum.fromValue(this.role));
            accessTokenPost.customRoleIds(this.customRoleIds);
            accessTokenPost.inlineRole(this.inlineRole);
            accessTokenPost.serviceToken(this.serviceToken);
            accessTokenPost.defaultApiVersion(this.defaultApiVersion);
            return accessTokenPost;
        }

        /**
         * Execute createNewToken request
         * @return Token
        ...
        public Token execute() throws ApiException {
            AccessTokenPost accessTokenPost = buildBodyParams();
            ApiResponse<Token> localVarResp = createNewTokenWithHttpInfo(accessTokenPost);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewToken request with HTTP info returned
        ...
        public ApiResponse<Token> executeWithHttpInfo() throws ApiException {
            AccessTokenPost accessTokenPost = buildBodyParams();
            return createNewTokenWithHttpInfo(accessTokenPost);
        }

        /**
         * Execute createNewToken request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Token> _callback) throws ApiException {
            AccessTokenPost accessTokenPost = buildBodyParams();
            return createNewTokenAsync(accessTokenPost, _callback);
        }
    }
     ...
     */
    public CreateNewTokenRequestBuilder createNewToken() throws IllegalArgumentException {
        return new CreateNewTokenRequestBuilder();
    }
    ...
    private ApiResponse<Token> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<Token> _callback) throws ApiException {
    ...
    private okhttp3.Call listCall(Boolean showAll, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Boolean showAll, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        return listCall(showAll, limit, offset, _callback);

    }


    private ApiResponse<Tokens> listWithHttpInfo(Boolean showAll, Long limit, Long offset) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(showAll, limit, offset, null);
        Type localVarReturnType = new TypeToken<Tokens>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Boolean showAll, Long limit, Long offset, final ApiCallback<Tokens> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(showAll, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<Tokens>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
         ...
         */
        public ListRequestBuilder showAll(Boolean showAll) {
         ...
         */
        public Tokens execute() throws ApiException {
            ApiResponse<Tokens> localVarResp = listWithHttpInfo(showAll, limit, offset);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<Tokens> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(showAll, limit, offset);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Tokens> _callback) throws ApiException {
            return listAsync(showAll, limit, offset, _callback);
        }
    }
    ...
    private okhttp3.Call resetSecretKeyCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resetSecretKeyValidateBeforeCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling resetSecretKey(Async)");
        }

        return resetSecretKeyCall(id, expiry, _callback);

    }


    private ApiResponse<Token> resetSecretKeyWithHttpInfo(String id, Long expiry) throws ApiException {
        okhttp3.Call localVarCall = resetSecretKeyValidateBeforeCall(id, expiry, null);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call resetSecretKeyAsync(String id, Long expiry, final ApiCallback<Token> _callback) throws ApiException {

        okhttp3.Call localVarCall = resetSecretKeyValidateBeforeCall(id, expiry, _callback);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ResetSecretKeyRequestBuilder {
        private final String id;
        private Long expiry;

        private ResetSecretKeyRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * @return ResetSecretKeyRequestBuilder
         */
        public ResetSecretKeyRequestBuilder expiry(Long expiry) {
            this.expiry = expiry;
            return this;
        }
        
        /**
         * Build call for resetSecretKey
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute resetSecretKey request
         * @return Token
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public Token execute() throws ApiException {
            ApiResponse<Token> localVarResp = resetSecretKeyWithHttpInfo(id, expiry);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute resetSecretKey request with HTTP info returned
         * @return ApiResponse&lt;Token&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Token> executeWithHttpInfo() throws ApiException {
            return resetSecretKeyWithHttpInfo(id, expiry);
        }

        /**
         * Execute resetSecretKey request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Token> _callback) throws ApiException {
            return resetSecretKeyAsync(id, expiry, _callback);
        }
    }
     ...
     */
    public ResetSecretKeyRequestBuilder resetSecretKey(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new ResetSecretKeyRequestBuilder(id);
    }
    private okhttp3.Call updateSettingsCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSettingsValidateBeforeCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSettings(Async)");
        }

        // verify the required parameter 'patchOperation' is set
        if (patchOperation == null) {
            throw new ApiException("Missing the required parameter 'patchOperation' when calling updateSettings(Async)");
        }

        return updateSettingsCall(id, patchOperation, _callback);

    }


    private ApiResponse<Token> updateSettingsWithHttpInfo(String id, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = updateSettingsValidateBeforeCall(id, patchOperation, null);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSettingsAsync(String id, List<PatchOperation> patchOperation, final ApiCallback<Token> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSettingsValidateBeforeCall(id, patchOperation, _callback);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateSettingsRequestBuilder {
        ...
        private UpdateSettingsRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public UpdateSettingsRequestBuilder patchOperation(List<PatchOperation> patchOperation) {
        ...
        public Token execute() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            ApiResponse<Token> localVarResp = updateSettingsWithHttpInfo(id, patchOperation);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<Token> executeWithHttpInfo() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateSettingsWithHttpInfo(id, patchOperation);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Token> _callback) throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateSettingsAsync(id, patchOperation, _callback);
        }
    }
     ...
     */
    public UpdateSettingsRequestBuilder updateSettings(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSettingsRequestBuilder(id);
    }
}
