...
import com.konfigthis.client.model.InsightsRepositoryCollection;
import com.konfigthis.client.model.InsightsRepositoryProject;
import com.konfigthis.client.model.InsightsRepositoryProjectCollection;
import com.konfigthis.client.model.InsightsRepositoryProjectMappings;
...
public class InsightsRepositoriesBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public InsightsRepositoriesBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public InsightsRepositoriesBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call associateRepositoriesAndProjectsCall(InsightsRepositoryProjectMappings insightsRepositoryProjectMappings, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<InsightsRepositoryProjectCollection> associateRepositoriesAndProjectsWithHttpInfo(InsightsRepositoryProjectMappings insightsRepositoryProjectMappings) throws ApiException {
    ...
    private okhttp3.Call associateRepositoriesAndProjectsAsync(InsightsRepositoryProjectMappings insightsRepositoryProjectMappings, final ApiCallback<InsightsRepositoryProjectCollection> _callback) throws ApiException {
    ...
    public class AssociateRepositoriesAndProjectsRequestBuilder {
        private final List<InsightsRepositoryProject> mappings;

        private AssociateRepositoriesAndProjectsRequestBuilder(List<InsightsRepositoryProject> mappings) {
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            InsightsRepositoryProjectMappings insightsRepositoryProjectMappings = buildBodyParams();
            return associateRepositoriesAndProjectsCall(insightsRepositoryProjectMappings, _callback);
        }

        private InsightsRepositoryProjectMappings buildBodyParams() {
            InsightsRepositoryProjectMappings insightsRepositoryProjectMappings = new InsightsRepositoryProjectMappings();
            insightsRepositoryProjectMappings.mappings(this.mappings);
            return insightsRepositoryProjectMappings;
        }

        /**
         * Execute associateRepositoriesAndProjects request
         ...
         */
        public InsightsRepositoryProjectCollection execute() throws ApiException {
            InsightsRepositoryProjectMappings insightsRepositoryProjectMappings = buildBodyParams();
        ...
        /**
         * Execute associateRepositoriesAndProjects request with HTTP info returned
         ...
         */
        public ApiResponse<InsightsRepositoryProjectCollection> executeWithHttpInfo() throws ApiException {
            InsightsRepositoryProjectMappings insightsRepositoryProjectMappings = buildBodyParams();
            return associateRepositoriesAndProjectsWithHttpInfo(insightsRepositoryProjectMappings);
        }

        /**
         * Execute associateRepositoriesAndProjects request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<InsightsRepositoryProjectCollection> _callback) throws ApiException {
            InsightsRepositoryProjectMappings insightsRepositoryProjectMappings = buildBodyParams();
            return associateRepositoriesAndProjectsAsync(insightsRepositoryProjectMappings, _callback);
        }
    }
     ...
     * @return AssociateRepositoriesAndProjectsRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Repositories projects response </td><td>  -  </td></tr>
     ...
     */
    public AssociateRepositoriesAndProjectsRequestBuilder associateRepositoriesAndProjects(List<InsightsRepositoryProject> mappings) throws IllegalArgumentException {
        if (mappings == null) throw new IllegalArgumentException("\"mappings\" is required but got null");
        return new AssociateRepositoriesAndProjectsRequestBuilder(mappings);
    }
    private okhttp3.Call listRepositoriesCall(String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listRepositoriesValidateBeforeCall(String expand, final ApiCallback _callback) throws ApiException {
        return listRepositoriesCall(expand, _callback);

    }


    private ApiResponse<InsightsRepositoryCollection> listRepositoriesWithHttpInfo(String expand) throws ApiException {
        okhttp3.Call localVarCall = listRepositoriesValidateBeforeCall(expand, null);
        Type localVarReturnType = new TypeToken<InsightsRepositoryCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listRepositoriesAsync(String expand, final ApiCallback<InsightsRepositoryCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = listRepositoriesValidateBeforeCall(expand, _callback);
        Type localVarReturnType = new TypeToken<InsightsRepositoryCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRepositoriesRequestBuilder {
         ...
         */
        public ListRepositoriesRequestBuilder expand(String expand) {
            this.expand = expand;
            return this;
        }
         ...
         */
        public InsightsRepositoryCollection execute() throws ApiException {
            ApiResponse<InsightsRepositoryCollection> localVarResp = listRepositoriesWithHttpInfo(expand);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<InsightsRepositoryCollection> executeWithHttpInfo() throws ApiException {
            return listRepositoriesWithHttpInfo(expand);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<InsightsRepositoryCollection> _callback) throws ApiException {
            return listRepositoriesAsync(expand, _callback);
        }
    }
    ...
    private okhttp3.Call removeRepositoryProjectAssociationCall(String repositoryKey, String projectKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeRepositoryProjectAssociationValidateBeforeCall(String repositoryKey, String projectKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'repositoryKey' is set
        if (repositoryKey == null) {
            throw new ApiException("Missing the required parameter 'repositoryKey' when calling removeRepositoryProjectAssociation(Async)");
        }

        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling removeRepositoryProjectAssociation(Async)");
        }

        return removeRepositoryProjectAssociationCall(repositoryKey, projectKey, _callback);

    }


    private ApiResponse<Void> removeRepositoryProjectAssociationWithHttpInfo(String repositoryKey, String projectKey) throws ApiException {
        okhttp3.Call localVarCall = removeRepositoryProjectAssociationValidateBeforeCall(repositoryKey, projectKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call removeRepositoryProjectAssociationAsync(String repositoryKey, String projectKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeRepositoryProjectAssociationValidateBeforeCall(repositoryKey, projectKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class RemoveRepositoryProjectAssociationRequestBuilder {
        private final String repositoryKey;
        private final String projectKey;

        private RemoveRepositoryProjectAssociationRequestBuilder(String repositoryKey, String projectKey) {
            this.repositoryKey = repositoryKey;
            this.projectKey = projectKey;
        }

        /**
         * Build call for removeRepositoryProjectAssociation
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute removeRepositoryProjectAssociation request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public void execute() throws ApiException {
            removeRepositoryProjectAssociationWithHttpInfo(repositoryKey, projectKey);
        }

        /**
         * Execute removeRepositoryProjectAssociation request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return removeRepositoryProjectAssociationWithHttpInfo(repositoryKey, projectKey);
        }

        /**
         * Execute removeRepositoryProjectAssociation request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return removeRepositoryProjectAssociationAsync(repositoryKey, projectKey, _callback);
        }
    }
     ...
     * @return RemoveRepositoryProjectAssociationRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Action succeeded </td><td>  -  </td></tr>
     ...
     */
    public RemoveRepositoryProjectAssociationRequestBuilder removeRepositoryProjectAssociation(String repositoryKey, String projectKey) throws IllegalArgumentException {
        if (repositoryKey == null) throw new IllegalArgumentException("\"repositoryKey\" is required but got null");
            

        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
            

        return new RemoveRepositoryProjectAssociationRequestBuilder(repositoryKey, projectKey);
    }
}
