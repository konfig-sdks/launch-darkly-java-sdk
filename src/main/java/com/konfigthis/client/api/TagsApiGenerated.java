...
import com.konfigthis.client.model.TagCollection;
...
public class TagsApiGenerated {
    ...
    private okhttp3.Call listCall(String kind, String pre, Boolean archived, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listValidateBeforeCall(String kind, String pre, Boolean archived, final ApiCallback _callback) throws ApiException {
        return listCall(kind, pre, archived, _callback);

    }


    private ApiResponse<TagCollection> listWithHttpInfo(String kind, String pre, Boolean archived) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(kind, pre, archived, null);
        Type localVarReturnType = new TypeToken<TagCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(String kind, String pre, Boolean archived, final ApiCallback<TagCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(kind, pre, archived, _callback);
        Type localVarReturnType = new TypeToken<TagCollection>(){}.getType();
    ...
    public class ListRequestBuilder {
         ...
         * @return ListRequestBuilder
         */
        public ListRequestBuilder pre(String pre) {
            this.pre = pre;
            return this;
        }
         ...
         */
        public TagCollection execute() throws ApiException {
            ApiResponse<TagCollection> localVarResp = listWithHttpInfo(kind, pre, archived);
         ...
         */
        public ApiResponse<TagCollection> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(kind, pre, archived);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TagCollection> _callback) throws ApiException {
            return listAsync(kind, pre, archived, _callback);
        }
    }
