...
import java.io.File;
import com.konfigthis.client.model.PermissionGrantInput;
import com.konfigthis.client.model.Team;
import com.konfigthis.client.model.TeamCustomRoles;
import com.konfigthis.client.model.TeamImportsRep;
import com.konfigthis.client.model.TeamMaintainers;
import com.konfigthis.client.model.TeamPatchInput;
import com.konfigthis.client.model.TeamPostInput;
import com.konfigthis.client.model.Teams;
import com.konfigthis.client.model.TeamsAddMultipleMembersToTeamRequest;
...
public class TeamsApiGenerated {
    ...
    private okhttp3.Call addMultipleMembersToTeamCall(String teamKey, TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest, File _file, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = teamsAddMultipleMembersToTeamRequest;
    ...
    private okhttp3.Call addMultipleMembersToTeamValidateBeforeCall(String teamKey, TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest, File _file, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamKey' is set
        if (teamKey == null) {
            throw new ApiException("Missing the required parameter 'teamKey' when calling addMultipleMembersToTeam(Async)");
        }

        // verify the required parameter 'teamsAddMultipleMembersToTeamRequest' is set
        if (teamsAddMultipleMembersToTeamRequest == null) {
            throw new ApiException("Missing the required parameter 'teamsAddMultipleMembersToTeamRequest' when calling addMultipleMembersToTeam(Async)");
        }

        return addMultipleMembersToTeamCall(teamKey, teamsAddMultipleMembersToTeamRequest, _file, _callback);

    }


    private ApiResponse<TeamImportsRep> addMultipleMembersToTeamWithHttpInfo(String teamKey, TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest, File _file) throws ApiException {
        okhttp3.Call localVarCall = addMultipleMembersToTeamValidateBeforeCall(teamKey, teamsAddMultipleMembersToTeamRequest, _file, null);
        Type localVarReturnType = new TypeToken<TeamImportsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call addMultipleMembersToTeamAsync(String teamKey, TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest, File _file, final ApiCallback<TeamImportsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = addMultipleMembersToTeamValidateBeforeCall(teamKey, teamsAddMultipleMembersToTeamRequest, _file, _callback);
        Type localVarReturnType = new TypeToken<TeamImportsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class AddMultipleMembersToTeamRequestBuilder {
        private final String teamKey;
        private File _file;

        private AddMultipleMembersToTeamRequestBuilder(String teamKey) {
         ...
         * @return AddMultipleMembersToTeamRequestBuilder
         */
        public AddMultipleMembersToTeamRequestBuilder _file(File _file) {
            this._file = _file;
            return this;
        }
        
        /**
         * Build call for addMultipleMembersToTeam
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest = buildBodyParams();
            return addMultipleMembersToTeamCall(teamKey, teamsAddMultipleMembersToTeamRequest, _file, _callback);
        }

        private TeamsAddMultipleMembersToTeamRequest buildBodyParams() {
            TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest = new TeamsAddMultipleMembersToTeamRequest();
            teamsAddMultipleMembersToTeamRequest._file(this._file);
            return teamsAddMultipleMembersToTeamRequest;
        }

        /**
         * Execute addMultipleMembersToTeam request
         ...
         */
        public TeamImportsRep execute() throws ApiException {
            TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest = buildBodyParams();
            ApiResponse<TeamImportsRep> localVarResp = addMultipleMembersToTeamWithHttpInfo(teamKey, teamsAddMultipleMembersToTeamRequest, _file);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute addMultipleMembersToTeam request with HTTP info returned
         ...
         */
        public ApiResponse<TeamImportsRep> executeWithHttpInfo() throws ApiException {
            TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest = buildBodyParams();
            return addMultipleMembersToTeamWithHttpInfo(teamKey, teamsAddMultipleMembersToTeamRequest, _file);
        }

        /**
         * Execute addMultipleMembersToTeam request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TeamImportsRep> _callback) throws ApiException {
            TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest = buildBodyParams();
            return addMultipleMembersToTeamAsync(teamKey, teamsAddMultipleMembersToTeamRequest, _file, _callback);
        }
    }
     ...
     * @param teamsAddMultipleMembersToTeamRequest  (required)
     * @return AddMultipleMembersToTeamRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public AddMultipleMembersToTeamRequestBuilder addMultipleMembersToTeam(String teamKey) throws IllegalArgumentException {
        if (teamKey == null) throw new IllegalArgumentException("\"teamKey\" is required but got null");
            

        return new AddMultipleMembersToTeamRequestBuilder(teamKey);
    }
    private okhttp3.Call createTeamCall(TeamPostInput teamPostInput, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createTeamValidateBeforeCall(TeamPostInput teamPostInput, String expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamPostInput' is set
        if (teamPostInput == null) {
            throw new ApiException("Missing the required parameter 'teamPostInput' when calling createTeam(Async)");
        }

        return createTeamCall(teamPostInput, expand, _callback);

    }


    private ApiResponse<Team> createTeamWithHttpInfo(TeamPostInput teamPostInput, String expand) throws ApiException {
        okhttp3.Call localVarCall = createTeamValidateBeforeCall(teamPostInput, expand, null);
        Type localVarReturnType = new TypeToken<Team>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createTeamAsync(TeamPostInput teamPostInput, String expand, final ApiCallback<Team> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTeamValidateBeforeCall(teamPostInput, expand, _callback);
        Type localVarReturnType = new TypeToken<Team>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class CreateTeamRequestBuilder {
        ...
        private List<String> customRoleKeys;
        private List<String> memberIDs;
        private List<PermissionGrantInput> permissionGrants;
        private String expand;

        private CreateTeamRequestBuilder(String key, String name) {
            this.key = key;
            this.name = name;
        }
        ...
        /**
         * Set description
         * @param description A description of the team (optional)
        ...
        /**
         * Set customRoleKeys
         * @param customRoleKeys List of custom role keys the team will access (optional)
         * @return CreateTeamRequestBuilder
         */
        public CreateTeamRequestBuilder customRoleKeys(List<String> customRoleKeys) {
        ...
        /**
         * Set memberIDs
         * @param memberIDs A list of member IDs who belong to the team (optional)
         * @return CreateTeamRequestBuilder
         */
        public CreateTeamRequestBuilder memberIDs(List<String> memberIDs) {
            this.memberIDs = memberIDs;
            return this;
        }
        
        /**
         * Set permissionGrants
         * @param permissionGrants A list of permission grants. Permission grants allow access to a specific action, without having to create or update a custom role. (optional)
         * @return CreateTeamRequestBuilder
         */
        public CreateTeamRequestBuilder permissionGrants(List<PermissionGrantInput> permissionGrants) {
         ...
         * @return CreateTeamRequestBuilder
         */
        public CreateTeamRequestBuilder expand(String expand) {
            this.expand = expand;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            TeamPostInput teamPostInput = buildBodyParams();
            return createTeamCall(teamPostInput, expand, _callback);
        }

        private TeamPostInput buildBodyParams() {
            TeamPostInput teamPostInput = new TeamPostInput();
            teamPostInput.description(this.description);
            teamPostInput.customRoleKeys(this.customRoleKeys);
            teamPostInput.key(this.key);
            teamPostInput.memberIDs(this.memberIDs);
            teamPostInput.name(this.name);
            teamPostInput.permissionGrants(this.permissionGrants);
            return teamPostInput;
        }
        ...
        public Team execute() throws ApiException {
            TeamPostInput teamPostInput = buildBodyParams();
            ApiResponse<Team> localVarResp = createTeamWithHttpInfo(teamPostInput, expand);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<Team> executeWithHttpInfo() throws ApiException {
            TeamPostInput teamPostInput = buildBodyParams();
            return createTeamWithHttpInfo(teamPostInput, expand);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Team> _callback) throws ApiException {
            TeamPostInput teamPostInput = buildBodyParams();
            return createTeamAsync(teamPostInput, expand, _callback);
        }
    }
     ...
     */
    public CreateTeamRequestBuilder createTeam(String key, String name) throws IllegalArgumentException {
        ...
        return new CreateTeamRequestBuilder(key, name);
    }
    private okhttp3.Call getByTeamKeyCall(String teamKey, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getByTeamKeyValidateBeforeCall(String teamKey, String expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamKey' is set
        if (teamKey == null) {
            throw new ApiException("Missing the required parameter 'teamKey' when calling getByTeamKey(Async)");
        }

        return getByTeamKeyCall(teamKey, expand, _callback);

    }


    private ApiResponse<Team> getByTeamKeyWithHttpInfo(String teamKey, String expand) throws ApiException {
        okhttp3.Call localVarCall = getByTeamKeyValidateBeforeCall(teamKey, expand, null);
        Type localVarReturnType = new TypeToken<Team>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByTeamKeyAsync(String teamKey, String expand, final ApiCallback<Team> _callback) throws ApiException {

        okhttp3.Call localVarCall = getByTeamKeyValidateBeforeCall(teamKey, expand, _callback);
        Type localVarReturnType = new TypeToken<Team>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetByTeamKeyRequestBuilder {
        private final String teamKey;
        private String expand;

        private GetByTeamKeyRequestBuilder(String teamKey) {
            this.teamKey = teamKey;
        }
         ...
         * @return GetByTeamKeyRequestBuilder
         */
        public GetByTeamKeyRequestBuilder expand(String expand) {
            this.expand = expand;
            return this;
        }
        
        /**
         * Build call for getByTeamKey
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public Team execute() throws ApiException {
            ApiResponse<Team> localVarResp = getByTeamKeyWithHttpInfo(teamKey, expand);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getByTeamKey request with HTTP info returned
         * @return ApiResponse&lt;Team&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Team> executeWithHttpInfo() throws ApiException {
            return getByTeamKeyWithHttpInfo(teamKey, expand);
        }

        /**
         * Execute getByTeamKey request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Team> _callback) throws ApiException {
            return getByTeamKeyAsync(teamKey, expand, _callback);
        }
    }
     ...
     */
    public GetByTeamKeyRequestBuilder getByTeamKey(String teamKey) throws IllegalArgumentException {
        if (teamKey == null) throw new IllegalArgumentException("\"teamKey\" is required but got null");
            

        return new GetByTeamKeyRequestBuilder(teamKey);
    }
    private okhttp3.Call getCustomRolesCall(String teamKey, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCustomRolesValidateBeforeCall(String teamKey, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamKey' is set
        if (teamKey == null) {
            throw new ApiException("Missing the required parameter 'teamKey' when calling getCustomRoles(Async)");
        }

        return getCustomRolesCall(teamKey, limit, offset, _callback);

    }


    private ApiResponse<TeamCustomRoles> getCustomRolesWithHttpInfo(String teamKey, Long limit, Long offset) throws ApiException {
        okhttp3.Call localVarCall = getCustomRolesValidateBeforeCall(teamKey, limit, offset, null);
        Type localVarReturnType = new TypeToken<TeamCustomRoles>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getCustomRolesAsync(String teamKey, Long limit, Long offset, final ApiCallback<TeamCustomRoles> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCustomRolesValidateBeforeCall(teamKey, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<TeamCustomRoles>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetCustomRolesRequestBuilder {
        private final String teamKey;
        private Long limit;
        private Long offset;

        private GetCustomRolesRequestBuilder(String teamKey) {
            this.teamKey = teamKey;
        }
         ...
         * @return GetCustomRolesRequestBuilder
         */
        public GetCustomRolesRequestBuilder limit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return GetCustomRolesRequestBuilder
         */
        public GetCustomRolesRequestBuilder offset(Long offset) {
            this.offset = offset;
            return this;
        }
        ...
        /**
         * Execute getCustomRoles request
         ...
         */
        public TeamCustomRoles execute() throws ApiException {
            ApiResponse<TeamCustomRoles> localVarResp = getCustomRolesWithHttpInfo(teamKey, limit, offset);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getCustomRoles request with HTTP info returned
         ...
         */
        public ApiResponse<TeamCustomRoles> executeWithHttpInfo() throws ApiException {
            return getCustomRolesWithHttpInfo(teamKey, limit, offset);
        }

        /**
         * Execute getCustomRoles request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TeamCustomRoles> _callback) throws ApiException {
            return getCustomRolesAsync(teamKey, limit, offset, _callback);
        }
    }
     ...
     */
    public GetCustomRolesRequestBuilder getCustomRoles(String teamKey) throws IllegalArgumentException {
        if (teamKey == null) throw new IllegalArgumentException("\"teamKey\" is required but got null");
            

        return new GetCustomRolesRequestBuilder(teamKey);
    }
    private okhttp3.Call getMaintainersCall(String teamKey, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMaintainersValidateBeforeCall(String teamKey, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamKey' is set
        if (teamKey == null) {
            throw new ApiException("Missing the required parameter 'teamKey' when calling getMaintainers(Async)");
        }

        return getMaintainersCall(teamKey, limit, offset, _callback);

    }


    private ApiResponse<TeamMaintainers> getMaintainersWithHttpInfo(String teamKey, Long limit, Long offset) throws ApiException {
        okhttp3.Call localVarCall = getMaintainersValidateBeforeCall(teamKey, limit, offset, null);
        Type localVarReturnType = new TypeToken<TeamMaintainers>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getMaintainersAsync(String teamKey, Long limit, Long offset, final ApiCallback<TeamMaintainers> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMaintainersValidateBeforeCall(teamKey, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<TeamMaintainers>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetMaintainersRequestBuilder {
        private final String teamKey;
        private Long limit;
        private Long offset;

        private GetMaintainersRequestBuilder(String teamKey) {
            this.teamKey = teamKey;
        }
         ...
         * @return GetMaintainersRequestBuilder
         */
        public GetMaintainersRequestBuilder limit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return GetMaintainersRequestBuilder
         */
        public GetMaintainersRequestBuilder offset(Long offset) {
            this.offset = offset;
            return this;
        }
        
        /**
         * Build call for getMaintainers
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getMaintainers request
         ...
         */
        public TeamMaintainers execute() throws ApiException {
            ApiResponse<TeamMaintainers> localVarResp = getMaintainersWithHttpInfo(teamKey, limit, offset);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getMaintainers request with HTTP info returned
         ...
         */
        public ApiResponse<TeamMaintainers> executeWithHttpInfo() throws ApiException {
            return getMaintainersWithHttpInfo(teamKey, limit, offset);
        }

        /**
         * Execute getMaintainers request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TeamMaintainers> _callback) throws ApiException {
            return getMaintainersAsync(teamKey, limit, offset, _callback);
        }
    }
     ...
     */
    public GetMaintainersRequestBuilder getMaintainers(String teamKey) throws IllegalArgumentException {
        if (teamKey == null) throw new IllegalArgumentException("\"teamKey\" is required but got null");
            

        return new GetMaintainersRequestBuilder(teamKey);
    }
    private okhttp3.Call listTeamsCall(Long limit, Long offset, String filter, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listTeamsValidateBeforeCall(Long limit, Long offset, String filter, String expand, final ApiCallback _callback) throws ApiException {
        return listTeamsCall(limit, offset, filter, expand, _callback);

    }


    private ApiResponse<Teams> listTeamsWithHttpInfo(Long limit, Long offset, String filter, String expand) throws ApiException {
        okhttp3.Call localVarCall = listTeamsValidateBeforeCall(limit, offset, filter, expand, null);
        Type localVarReturnType = new TypeToken<Teams>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listTeamsAsync(Long limit, Long offset, String filter, String expand, final ApiCallback<Teams> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTeamsValidateBeforeCall(limit, offset, filter, expand, _callback);
        Type localVarReturnType = new TypeToken<Teams>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListTeamsRequestBuilder {
         ...
         */
        public ListTeamsRequestBuilder limit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListTeamsRequestBuilder
         */
        public ListTeamsRequestBuilder offset(Long offset) {
            this.offset = offset;
            return this;
        }
         ...
         * @return ListTeamsRequestBuilder
         */
        public ListTeamsRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return ListTeamsRequestBuilder
         */
        public ListTeamsRequestBuilder expand(String expand) {
            this.expand = expand;
            return this;
        }
        ...
        public Teams execute() throws ApiException {
            ApiResponse<Teams> localVarResp = listTeamsWithHttpInfo(limit, offset, filter, expand);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<Teams> executeWithHttpInfo() throws ApiException {
            return listTeamsWithHttpInfo(limit, offset, filter, expand);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Teams> _callback) throws ApiException {
            return listTeamsAsync(limit, offset, filter, expand, _callback);
        }
    }
    ...
    private okhttp3.Call removeByTeamKeyCall(String teamKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeByTeamKeyValidateBeforeCall(String teamKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamKey' is set
        if (teamKey == null) {
            throw new ApiException("Missing the required parameter 'teamKey' when calling removeByTeamKey(Async)");
        }

        return removeByTeamKeyCall(teamKey, _callback);

    }


    private ApiResponse<Void> removeByTeamKeyWithHttpInfo(String teamKey) throws ApiException {
        okhttp3.Call localVarCall = removeByTeamKeyValidateBeforeCall(teamKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call removeByTeamKeyAsync(String teamKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeByTeamKeyValidateBeforeCall(teamKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class RemoveByTeamKeyRequestBuilder {
        private final String teamKey;

        private RemoveByTeamKeyRequestBuilder(String teamKey) {
            this.teamKey = teamKey;
        }

        /**
         * Build call for removeByTeamKey
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute removeByTeamKey request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public void execute() throws ApiException {
            removeByTeamKeyWithHttpInfo(teamKey);
        }

        /**
         * Execute removeByTeamKey request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return removeByTeamKeyWithHttpInfo(teamKey);
        }

        /**
         * Execute removeByTeamKey request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return removeByTeamKeyAsync(teamKey, _callback);
        }
    }
     ...
     * @param teamKey The team key (required)
     * @return RemoveByTeamKeyRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Action succeeded </td><td>  -  </td></tr>
     ...
     */
    public RemoveByTeamKeyRequestBuilder removeByTeamKey(String teamKey) throws IllegalArgumentException {
        if (teamKey == null) throw new IllegalArgumentException("\"teamKey\" is required but got null");
            

        return new RemoveByTeamKeyRequestBuilder(teamKey);
    }
    private okhttp3.Call updateSemanticPatchCall(String teamKey, TeamPatchInput teamPatchInput, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSemanticPatchValidateBeforeCall(String teamKey, TeamPatchInput teamPatchInput, String expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamKey' is set
        if (teamKey == null) {
            throw new ApiException("Missing the required parameter 'teamKey' when calling updateSemanticPatch(Async)");
        }

        // verify the required parameter 'teamPatchInput' is set
        if (teamPatchInput == null) {
            throw new ApiException("Missing the required parameter 'teamPatchInput' when calling updateSemanticPatch(Async)");
        }

        return updateSemanticPatchCall(teamKey, teamPatchInput, expand, _callback);

    }


    private ApiResponse<Team> updateSemanticPatchWithHttpInfo(String teamKey, TeamPatchInput teamPatchInput, String expand) throws ApiException {
        okhttp3.Call localVarCall = updateSemanticPatchValidateBeforeCall(teamKey, teamPatchInput, expand, null);
        Type localVarReturnType = new TypeToken<Team>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSemanticPatchAsync(String teamKey, TeamPatchInput teamPatchInput, String expand, final ApiCallback<Team> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSemanticPatchValidateBeforeCall(teamKey, teamPatchInput, expand, _callback);
        Type localVarReturnType = new TypeToken<Team>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateSemanticPatchRequestBuilder {
        ...
        private UpdateSemanticPatchRequestBuilder(List<Map<String, Object>> instructions, String teamKey) {
         ...
         * @return UpdateSemanticPatchRequestBuilder
         */
        public UpdateSemanticPatchRequestBuilder expand(String expand) {
            this.expand = expand;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            TeamPatchInput teamPatchInput = buildBodyParams();
            return updateSemanticPatchCall(teamKey, teamPatchInput, expand, _callback);
        }

        private TeamPatchInput buildBodyParams() {
            TeamPatchInput teamPatchInput = new TeamPatchInput();
            teamPatchInput.comment(this.comment);
            teamPatchInput.instructions(this.instructions);
            return teamPatchInput;
        }
        ...
        public Team execute() throws ApiException {
            TeamPatchInput teamPatchInput = buildBodyParams();
            ApiResponse<Team> localVarResp = updateSemanticPatchWithHttpInfo(teamKey, teamPatchInput, expand);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<Team> executeWithHttpInfo() throws ApiException {
            TeamPatchInput teamPatchInput = buildBodyParams();
            return updateSemanticPatchWithHttpInfo(teamKey, teamPatchInput, expand);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Team> _callback) throws ApiException {
            TeamPatchInput teamPatchInput = buildBodyParams();
            return updateSemanticPatchAsync(teamKey, teamPatchInput, expand, _callback);
        }
    }
     ...
     */
    public UpdateSemanticPatchRequestBuilder updateSemanticPatch(List<Map<String, Object>> instructions, String teamKey) throws IllegalArgumentException {
        if (instructions == null) throw new IllegalArgumentException("\"instructions\" is required but got null");
        if (teamKey == null) throw new IllegalArgumentException("\"teamKey\" is required but got null");
            

        return new UpdateSemanticPatchRequestBuilder(instructions, teamKey);
    }
}
