...
import com.konfigthis.client.model.UserAttributeNamesRep;
...
public class UsersBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public UsersBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public UsersBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getAllInUseUserAttributesCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllInUseUserAttributesValidateBeforeCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getAllInUseUserAttributes(Async)");
        }

        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getAllInUseUserAttributes(Async)");
        }

        return getAllInUseUserAttributesCall(projectKey, environmentKey, _callback);

    }


    private ApiResponse<UserAttributeNamesRep> getAllInUseUserAttributesWithHttpInfo(String projectKey, String environmentKey) throws ApiException {
        okhttp3.Call localVarCall = getAllInUseUserAttributesValidateBeforeCall(projectKey, environmentKey, null);
        Type localVarReturnType = new TypeToken<UserAttributeNamesRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAllInUseUserAttributesAsync(String projectKey, String environmentKey, final ApiCallback<UserAttributeNamesRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllInUseUserAttributesValidateBeforeCall(projectKey, environmentKey, _callback);
        Type localVarReturnType = new TypeToken<UserAttributeNamesRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetAllInUseUserAttributesRequestBuilder {
        private final String projectKey;
        private final String environmentKey;

        private GetAllInUseUserAttributesRequestBuilder(String projectKey, String environmentKey) {
            this.projectKey = projectKey;
            this.environmentKey = environmentKey;
        }

        /**
         * Build call for getAllInUseUserAttributes
        ...
        /**
         * Execute getAllInUseUserAttributes request
         ...
         */
        @Deprecated
        public UserAttributeNamesRep execute() throws ApiException {
            ApiResponse<UserAttributeNamesRep> localVarResp = getAllInUseUserAttributesWithHttpInfo(projectKey, environmentKey);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getAllInUseUserAttributes request with HTTP info returned
         ...
         */
        @Deprecated
        public ApiResponse<UserAttributeNamesRep> executeWithHttpInfo() throws ApiException {
            return getAllInUseUserAttributesWithHttpInfo(projectKey, environmentKey);
        }

        /**
         * Execute getAllInUseUserAttributes request (asynchronously)
         ...
         */
        @Deprecated
        public okhttp3.Call executeAsync(final ApiCallback<UserAttributeNamesRep> _callback) throws ApiException {
            return getAllInUseUserAttributesAsync(projectKey, environmentKey, _callback);
        }
    }
     ...
     * @return GetAllInUseUserAttributesRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> User attribute names response </td><td>  -  </td></tr>
     ...
     */
    @Deprecated
    public GetAllInUseUserAttributesRequestBuilder getAllInUseUserAttributes(String projectKey, String environmentKey) throws IllegalArgumentException {
        ...
        return new GetAllInUseUserAttributesRequestBuilder(projectKey, environmentKey);
    }
}
