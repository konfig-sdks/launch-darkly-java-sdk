...
import com.konfigthis.client.model.FlagLinkCollectionRep;
import com.konfigthis.client.model.FlagLinkPost;
import com.konfigthis.client.model.FlagLinkRep;
...
public class FlagLinksBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public FlagLinksBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public FlagLinksBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createFlagLinkCall(String projectKey, String featureFlagKey, FlagLinkPost flagLinkPost, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<FlagLinkRep> createFlagLinkWithHttpInfo(String projectKey, String featureFlagKey, FlagLinkPost flagLinkPost) throws ApiException {
    ...
    private okhttp3.Call createFlagLinkAsync(String projectKey, String featureFlagKey, FlagLinkPost flagLinkPost, final ApiCallback<FlagLinkRep> _callback) throws ApiException {
    ...
    public class CreateFlagLinkRequestBuilder {
        ...
        private CreateFlagLinkRequestBuilder(String projectKey, String featureFlagKey) {
        ...
        /**
         * Set title
         * @param title The title of the flag link (optional)
         * @return CreateFlagLinkRequestBuilder
         */
        public CreateFlagLinkRequestBuilder title(String title) {
            this.title = title;
            return this;
        }
        ...
        /**
         * Set description
         * @param description The description of the flag link (optional)
         * @return CreateFlagLinkRequestBuilder
         */
        public CreateFlagLinkRequestBuilder description(String description) {
        ...
        /**
         * Set key
         * @param key The flag link key (optional)
         * @return CreateFlagLinkRequestBuilder
         */
        public CreateFlagLinkRequestBuilder key(String key) {
            this.key = key;
            return this;
        }
        ...
        /**
         * Set integrationKey
         * @param integrationKey The integration key for an integration whose &lt;code&gt;manifest.json&lt;/code&gt; includes the &lt;code&gt;flagLink&lt;/code&gt; capability, if this is a flag link for an existing integration. Do not include for URL flag links. (optional)
         * @return CreateFlagLinkRequestBuilder
         */
        public CreateFlagLinkRequestBuilder integrationKey(String integrationKey) {
         ...
         * @return CreateFlagLinkRequestBuilder
         */
        public CreateFlagLinkRequestBuilder timestamp(Long timestamp) {
        ...
        /**
         * Set deepLink
         * @param deepLink The URL for the external resource you are linking the flag to (optional)
         * @return CreateFlagLinkRequestBuilder
         */
        public CreateFlagLinkRequestBuilder deepLink(String deepLink) {
        ...
        /**
         * Set metadata
         * @param metadata The metadata required by this integration in order to create a flag link, if this is a flag link for an existing integration. Defined in the integration&#39;s &lt;code&gt;manifest.json&lt;/code&gt; file under &lt;code&gt;flagLink&lt;/code&gt;. (optional)
         * @return CreateFlagLinkRequestBuilder
         */
        public CreateFlagLinkRequestBuilder metadata(Map<String, String> metadata) {
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FlagLinkPost flagLinkPost = buildBodyParams();
            return createFlagLinkCall(projectKey, featureFlagKey, flagLinkPost, _callback);
        }

        private FlagLinkPost buildBodyParams() {
            FlagLinkPost flagLinkPost = new FlagLinkPost();
            flagLinkPost.title(this.title);
            flagLinkPost.description(this.description);
            flagLinkPost.key(this.key);
            flagLinkPost.integrationKey(this.integrationKey);
            flagLinkPost.timestamp(this.timestamp);
            flagLinkPost.deepLink(this.deepLink);
            flagLinkPost.metadata(this.metadata);
            return flagLinkPost;
        }

        /**
         * Execute createFlagLink request
         * @return FlagLinkRep
         ...
         */
        public FlagLinkRep execute() throws ApiException {
            FlagLinkPost flagLinkPost = buildBodyParams();
        ...
        /**
         * Execute createFlagLink request with HTTP info returned
         ...
         */
        public ApiResponse<FlagLinkRep> executeWithHttpInfo() throws ApiException {
            FlagLinkPost flagLinkPost = buildBodyParams();
            return createFlagLinkWithHttpInfo(projectKey, featureFlagKey, flagLinkPost);
        }

        /**
         * Execute createFlagLink request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FlagLinkRep> _callback) throws ApiException {
            FlagLinkPost flagLinkPost = buildBodyParams();
            return createFlagLinkAsync(projectKey, featureFlagKey, flagLinkPost, _callback);
        }
    }
     ...
     */
    public CreateFlagLinkRequestBuilder createFlagLink(String projectKey, String featureFlagKey) throws IllegalArgumentException {
        ...
        return new CreateFlagLinkRequestBuilder(projectKey, featureFlagKey);
    }
    private okhttp3.Call deleteFlagLinkCall(String projectKey, String featureFlagKey, String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<Void> deleteFlagLinkWithHttpInfo(String projectKey, String featureFlagKey, String id) throws ApiException {
        okhttp3.Call localVarCall = deleteFlagLinkValidateBeforeCall(projectKey, featureFlagKey, id, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteFlagLinkAsync(String projectKey, String featureFlagKey, String id, final ApiCallback<Void> _callback) throws ApiException {
    ...
    public class DeleteFlagLinkRequestBuilder {
        private final String projectKey;
        private final String featureFlagKey;
        private final String id;

        private DeleteFlagLinkRequestBuilder(String projectKey, String featureFlagKey, String id) {
            this.projectKey = projectKey;
            this.featureFlagKey = featureFlagKey;
            this.id = id;
        }
        ...
        /**
         * Execute deleteFlagLink request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        /**
         * Execute deleteFlagLink request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteFlagLinkWithHttpInfo(projectKey, featureFlagKey, id);
        }

        /**
         * Execute deleteFlagLink request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteFlagLinkAsync(projectKey, featureFlagKey, id, _callback);
        }
    }
     ...
     * @return DeleteFlagLinkRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Action succeeded </td><td>  -  </td></tr>
     ...
     */
    public DeleteFlagLinkRequestBuilder deleteFlagLink(String projectKey, String featureFlagKey, String id) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
        ...
        return new DeleteFlagLinkRequestBuilder(projectKey, featureFlagKey, id);
    }
    private okhttp3.Call listLinksCall(String projectKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listLinksValidateBeforeCall(String projectKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling listLinks(Async)");
        }

        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling listLinks(Async)");
        }

        return listLinksCall(projectKey, featureFlagKey, _callback);

    }


    private ApiResponse<FlagLinkCollectionRep> listLinksWithHttpInfo(String projectKey, String featureFlagKey) throws ApiException {
        okhttp3.Call localVarCall = listLinksValidateBeforeCall(projectKey, featureFlagKey, null);
        Type localVarReturnType = new TypeToken<FlagLinkCollectionRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listLinksAsync(String projectKey, String featureFlagKey, final ApiCallback<FlagLinkCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = listLinksValidateBeforeCall(projectKey, featureFlagKey, _callback);
        Type localVarReturnType = new TypeToken<FlagLinkCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListLinksRequestBuilder {
        private final String projectKey;
        private final String featureFlagKey;

        private ListLinksRequestBuilder(String projectKey, String featureFlagKey) {
            this.projectKey = projectKey;
            this.featureFlagKey = featureFlagKey;
        }
         ...
         */
        public FlagLinkCollectionRep execute() throws ApiException {
            ApiResponse<FlagLinkCollectionRep> localVarResp = listLinksWithHttpInfo(projectKey, featureFlagKey);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listLinks request with HTTP info returned
         ...
         */
        public ApiResponse<FlagLinkCollectionRep> executeWithHttpInfo() throws ApiException {
            return listLinksWithHttpInfo(projectKey, featureFlagKey);
        }

        /**
         * Execute listLinks request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FlagLinkCollectionRep> _callback) throws ApiException {
            return listLinksAsync(projectKey, featureFlagKey, _callback);
        }
    }
     ...
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @return ListLinksRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Flag link collection response </td><td>  -  </td></tr>
     ...
     */
    public ListLinksRequestBuilder listLinks(String projectKey, String featureFlagKey) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
        ...
        return new ListLinksRequestBuilder(projectKey, featureFlagKey);
    }
    private okhttp3.Call updateFlagLinkCall(String projectKey, String featureFlagKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<FlagLinkRep> updateFlagLinkWithHttpInfo(String projectKey, String featureFlagKey, String id, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = updateFlagLinkValidateBeforeCall(projectKey, featureFlagKey, id, patchOperation, null);
        Type localVarReturnType = new TypeToken<FlagLinkRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateFlagLinkAsync(String projectKey, String featureFlagKey, String id, List<PatchOperation> patchOperation, final ApiCallback<FlagLinkRep> _callback) throws ApiException {
    ...
    public class UpdateFlagLinkRequestBuilder {
        private final String projectKey;
        private final String featureFlagKey;
        private final String id;
        private List<PatchOperation> patchOperation;

        private UpdateFlagLinkRequestBuilder(String projectKey, String featureFlagKey, String id) {
            this.projectKey = projectKey;
            this.featureFlagKey = featureFlagKey;
            this.id = id;
        }
         ...
         * @return UpdateFlagLinkRequestBuilder
         */
        public UpdateFlagLinkRequestBuilder patchOperation(List<PatchOperation> patchOperation) {
        ...
        /**
         * Execute updateFlagLink request
         * @return FlagLinkRep
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        /**
         * Execute updateFlagLink request with HTTP info returned
         * @return ApiResponse&lt;FlagLinkRep&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<FlagLinkRep> executeWithHttpInfo() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateFlagLinkWithHttpInfo(projectKey, featureFlagKey, id, patchOperation);
        }

        /**
         * Execute updateFlagLink request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<FlagLinkRep> _callback) throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateFlagLinkAsync(projectKey, featureFlagKey, id, patchOperation, _callback);
        }
    }
     ...
     */
    public UpdateFlagLinkRequestBuilder updateFlagLink(String projectKey, String featureFlagKey, String id) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
        ...
        return new UpdateFlagLinkRequestBuilder(projectKey, featureFlagKey, id);
    }
}
