...
import com.konfigthis.client.model.BulkEditTeamsRep;
import com.konfigthis.client.model.TeamsPatchInput;
...
public class TeamsBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TeamsBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public TeamsBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call updateMultipleTeamsSemanticPatchCall(TeamsPatchInput teamsPatchInput, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call updateMultipleTeamsSemanticPatchValidateBeforeCall(TeamsPatchInput teamsPatchInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamsPatchInput' is set
        if (teamsPatchInput == null) {
            throw new ApiException("Missing the required parameter 'teamsPatchInput' when calling updateMultipleTeamsSemanticPatch(Async)");
        }

        return updateMultipleTeamsSemanticPatchCall(teamsPatchInput, _callback);

    }


    private ApiResponse<BulkEditTeamsRep> updateMultipleTeamsSemanticPatchWithHttpInfo(TeamsPatchInput teamsPatchInput) throws ApiException {
        okhttp3.Call localVarCall = updateMultipleTeamsSemanticPatchValidateBeforeCall(teamsPatchInput, null);
        Type localVarReturnType = new TypeToken<BulkEditTeamsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateMultipleTeamsSemanticPatchAsync(TeamsPatchInput teamsPatchInput, final ApiCallback<BulkEditTeamsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateMultipleTeamsSemanticPatchValidateBeforeCall(teamsPatchInput, _callback);
        Type localVarReturnType = new TypeToken<BulkEditTeamsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateMultipleTeamsSemanticPatchRequestBuilder {
        private final List<Map<String, Object>> instructions;
        private String comment;

        private UpdateMultipleTeamsSemanticPatchRequestBuilder(List<Map<String, Object>> instructions) {
         ...
         * @return UpdateMultipleTeamsSemanticPatchRequestBuilder
         */
        public UpdateMultipleTeamsSemanticPatchRequestBuilder comment(String comment) {
            this.comment = comment;
            return this;
        }
        
        /**
         * Build call for updateMultipleTeamsSemanticPatch
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            TeamsPatchInput teamsPatchInput = buildBodyParams();
            return updateMultipleTeamsSemanticPatchCall(teamsPatchInput, _callback);
        }

        private TeamsPatchInput buildBodyParams() {
            TeamsPatchInput teamsPatchInput = new TeamsPatchInput();
            teamsPatchInput.comment(this.comment);
            teamsPatchInput.instructions(this.instructions);
            return teamsPatchInput;
        }

        /**
         * Execute updateMultipleTeamsSemanticPatch request
         ...
         */
        public BulkEditTeamsRep execute() throws ApiException {
            TeamsPatchInput teamsPatchInput = buildBodyParams();
            ApiResponse<BulkEditTeamsRep> localVarResp = updateMultipleTeamsSemanticPatchWithHttpInfo(teamsPatchInput);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateMultipleTeamsSemanticPatch request with HTTP info returned
         ...
         */
        public ApiResponse<BulkEditTeamsRep> executeWithHttpInfo() throws ApiException {
            TeamsPatchInput teamsPatchInput = buildBodyParams();
            return updateMultipleTeamsSemanticPatchWithHttpInfo(teamsPatchInput);
        }

        /**
         * Execute updateMultipleTeamsSemanticPatch request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<BulkEditTeamsRep> _callback) throws ApiException {
            TeamsPatchInput teamsPatchInput = buildBodyParams();
            return updateMultipleTeamsSemanticPatchAsync(teamsPatchInput, _callback);
        }
    }
     ...
     */
    public UpdateMultipleTeamsSemanticPatchRequestBuilder updateMultipleTeamsSemanticPatch(List<Map<String, Object>> instructions) throws IllegalArgumentException {
        if (instructions == null) throw new IllegalArgumentException("\"instructions\" is required but got null");
        return new UpdateMultipleTeamsSemanticPatchRequestBuilder(instructions);
    }
}
