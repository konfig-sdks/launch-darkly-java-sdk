...
public class ContextSettingsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ContextSettingsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ContextSettingsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call updateSettingsForContextCall(String projectKey, String environmentKey, String contextKind, String contextKey, String featureFlagKey, ValuePut valuePut, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call updateSettingsForContextValidateBeforeCall(String projectKey, String environmentKey, String contextKind, String contextKey, String featureFlagKey, ValuePut valuePut, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling updateSettingsForContext(Async)");
        }

        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling updateSettingsForContext(Async)");
        }

        // verify the required parameter 'contextKind' is set
        if (contextKind == null) {
            throw new ApiException("Missing the required parameter 'contextKind' when calling updateSettingsForContext(Async)");
        }

        // verify the required parameter 'contextKey' is set
        if (contextKey == null) {
            throw new ApiException("Missing the required parameter 'contextKey' when calling updateSettingsForContext(Async)");
        }

        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling updateSettingsForContext(Async)");
        }

        // verify the required parameter 'valuePut' is set
        if (valuePut == null) {
            throw new ApiException("Missing the required parameter 'valuePut' when calling updateSettingsForContext(Async)");
        }

        return updateSettingsForContextCall(projectKey, environmentKey, contextKind, contextKey, featureFlagKey, valuePut, _callback);

    }


    private ApiResponse<Void> updateSettingsForContextWithHttpInfo(String projectKey, String environmentKey, String contextKind, String contextKey, String featureFlagKey, ValuePut valuePut) throws ApiException {
        okhttp3.Call localVarCall = updateSettingsForContextValidateBeforeCall(projectKey, environmentKey, contextKind, contextKey, featureFlagKey, valuePut, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call updateSettingsForContextAsync(String projectKey, String environmentKey, String contextKind, String contextKey, String featureFlagKey, ValuePut valuePut, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSettingsForContextValidateBeforeCall(projectKey, environmentKey, contextKind, contextKey, featureFlagKey, valuePut, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class UpdateSettingsForContextRequestBuilder {
        ...
        private UpdateSettingsForContextRequestBuilder(String projectKey, String environmentKey, String contextKind, String contextKey, String featureFlagKey) {
         ...
         * @return UpdateSettingsForContextRequestBuilder
         */
        public UpdateSettingsForContextRequestBuilder setting(Object setting) {
         ...
         * @return UpdateSettingsForContextRequestBuilder
         */
        public UpdateSettingsForContextRequestBuilder comment(String comment) {
            this.comment = comment;
            return this;
        }
        
        /**
         * Build call for updateSettingsForContext
        ...
        /**
         * Execute updateSettingsForContext request
        ...
        public void execute() throws ApiException {
            ValuePut valuePut = buildBodyParams();
            updateSettingsForContextWithHttpInfo(projectKey, environmentKey, contextKind, contextKey, featureFlagKey, valuePut);
        }

        /**
         * Execute updateSettingsForContext request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            ValuePut valuePut = buildBodyParams();
            return updateSettingsForContextWithHttpInfo(projectKey, environmentKey, contextKind, contextKey, featureFlagKey, valuePut);
        }

        /**
         * Execute updateSettingsForContext request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            ValuePut valuePut = buildBodyParams();
            return updateSettingsForContextAsync(projectKey, environmentKey, contextKind, contextKey, featureFlagKey, valuePut, _callback);
        }
    }
     ...
     */
    public UpdateSettingsForContextRequestBuilder updateSettingsForContext(String projectKey, String environmentKey, String contextKind, String contextKey, String featureFlagKey) throws IllegalArgumentException {
        ...
        if (contextKind == null) throw new IllegalArgumentException("\"contextKind\" is required but got null");
        ...
        return new UpdateSettingsForContextRequestBuilder(projectKey, environmentKey, contextKind, contextKey, featureFlagKey);
    }
}
