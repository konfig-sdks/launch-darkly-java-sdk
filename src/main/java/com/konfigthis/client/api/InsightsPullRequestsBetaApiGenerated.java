...
import com.konfigthis.client.model.PullRequestCollectionRep;
...
public class InsightsPullRequestsBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public InsightsPullRequestsBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public InsightsPullRequestsBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listPullRequestsCall(String projectKey, String environmentKey, String applicationKey, String status, String query, Long limit, String expand, String sort, OffsetDateTime from, OffsetDateTime to, String after, String before, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listPullRequestsValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, String status, String query, Long limit, String expand, String sort, OffsetDateTime from, OffsetDateTime to, String after, String before, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling listPullRequests(Async)");
        }

        return listPullRequestsCall(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before, _callback);

    }


    private ApiResponse<PullRequestCollectionRep> listPullRequestsWithHttpInfo(String projectKey, String environmentKey, String applicationKey, String status, String query, Long limit, String expand, String sort, OffsetDateTime from, OffsetDateTime to, String after, String before) throws ApiException {
        okhttp3.Call localVarCall = listPullRequestsValidateBeforeCall(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before, null);
        Type localVarReturnType = new TypeToken<PullRequestCollectionRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listPullRequestsAsync(String projectKey, String environmentKey, String applicationKey, String status, String query, Long limit, String expand, String sort, OffsetDateTime from, OffsetDateTime to, String after, String before, final ApiCallback<PullRequestCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = listPullRequestsValidateBeforeCall(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before, _callback);
        Type localVarReturnType = new TypeToken<PullRequestCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListPullRequestsRequestBuilder {
        ...
        private ListPullRequestsRequestBuilder(String projectKey) {
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder environmentKey(String environmentKey) {
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder applicationKey(String applicationKey) {
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder status(String status) {
            this.status = status;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder query(String query) {
            this.query = query;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder limit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder expand(String expand) {
            this.expand = expand;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder sort(String sort) {
            this.sort = sort;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder from(OffsetDateTime from) {
            this.from = from;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder to(OffsetDateTime to) {
            this.to = to;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListPullRequestsRequestBuilder
         */
        public ListPullRequestsRequestBuilder before(String before) {
            this.before = before;
            return this;
        }
         ...
         */
        public PullRequestCollectionRep execute() throws ApiException {
            ApiResponse<PullRequestCollectionRep> localVarResp = listPullRequestsWithHttpInfo(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before);
         ...
         */
        public ApiResponse<PullRequestCollectionRep> executeWithHttpInfo() throws ApiException {
            return listPullRequestsWithHttpInfo(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PullRequestCollectionRep> _callback) throws ApiException {
            return listPullRequestsAsync(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before, _callback);
        }
    }
     ...
     */
    public ListPullRequestsRequestBuilder listPullRequests(String projectKey) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
            

        return new ListPullRequestsRequestBuilder(projectKey);
    }
}
