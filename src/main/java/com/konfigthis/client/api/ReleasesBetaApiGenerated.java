...
import com.konfigthis.client.model.Release;
...
public class ReleasesBetaApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ReleasesBetaApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ReleasesBetaApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getCurrentReleaseCall(String projectKey, String flagKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getCurrentReleaseValidateBeforeCall(String projectKey, String flagKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getCurrentRelease(Async)");
        }

        // verify the required parameter 'flagKey' is set
        if (flagKey == null) {
            throw new ApiException("Missing the required parameter 'flagKey' when calling getCurrentRelease(Async)");
        }

        return getCurrentReleaseCall(projectKey, flagKey, _callback);

    }


    private ApiResponse<Release> getCurrentReleaseWithHttpInfo(String projectKey, String flagKey) throws ApiException {
        okhttp3.Call localVarCall = getCurrentReleaseValidateBeforeCall(projectKey, flagKey, null);
        Type localVarReturnType = new TypeToken<Release>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getCurrentReleaseAsync(String projectKey, String flagKey, final ApiCallback<Release> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCurrentReleaseValidateBeforeCall(projectKey, flagKey, _callback);
        Type localVarReturnType = new TypeToken<Release>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetCurrentReleaseRequestBuilder {
        private final String projectKey;
        private final String flagKey;

        private GetCurrentReleaseRequestBuilder(String projectKey, String flagKey) {
            this.projectKey = projectKey;
            this.flagKey = flagKey;
        }

        /**
         * Build call for getCurrentRelease
        ...
        /**
         * Execute getCurrentRelease request
         * @return Release
         ...
         */
        public Release execute() throws ApiException {
            ApiResponse<Release> localVarResp = getCurrentReleaseWithHttpInfo(projectKey, flagKey);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getCurrentRelease request with HTTP info returned
         ...
         */
        public ApiResponse<Release> executeWithHttpInfo() throws ApiException {
            return getCurrentReleaseWithHttpInfo(projectKey, flagKey);
        }

        /**
         * Execute getCurrentRelease request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Release> _callback) throws ApiException {
            return getCurrentReleaseAsync(projectKey, flagKey, _callback);
        }
    }
     ...
     * @return GetCurrentReleaseRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Release response </td><td>  -  </td></tr>
     ...
     */
    public GetCurrentReleaseRequestBuilder getCurrentRelease(String projectKey, String flagKey) throws IllegalArgumentException {
        ...
        return new GetCurrentReleaseRequestBuilder(projectKey, flagKey);
    }
    private okhttp3.Call updateActiveReleasePatchCall(String projectKey, String flagKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateActiveReleasePatchValidateBeforeCall(String projectKey, String flagKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling updateActiveReleasePatch(Async)");
        }

        // verify the required parameter 'flagKey' is set
        if (flagKey == null) {
            throw new ApiException("Missing the required parameter 'flagKey' when calling updateActiveReleasePatch(Async)");
        }

        // verify the required parameter 'patchOperation' is set
        if (patchOperation == null) {
            throw new ApiException("Missing the required parameter 'patchOperation' when calling updateActiveReleasePatch(Async)");
        }

        return updateActiveReleasePatchCall(projectKey, flagKey, patchOperation, _callback);

    }


    private ApiResponse<Release> updateActiveReleasePatchWithHttpInfo(String projectKey, String flagKey, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = updateActiveReleasePatchValidateBeforeCall(projectKey, flagKey, patchOperation, null);
        Type localVarReturnType = new TypeToken<Release>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateActiveReleasePatchAsync(String projectKey, String flagKey, List<PatchOperation> patchOperation, final ApiCallback<Release> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateActiveReleasePatchValidateBeforeCall(projectKey, flagKey, patchOperation, _callback);
        Type localVarReturnType = new TypeToken<Release>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateActiveReleasePatchRequestBuilder {
        private final String projectKey;
        private final String flagKey;
        private List<PatchOperation> patchOperation;

        private UpdateActiveReleasePatchRequestBuilder(String projectKey, String flagKey) {
            this.projectKey = projectKey;
            this.flagKey = flagKey;
        }
         ...
         * @return UpdateActiveReleasePatchRequestBuilder
         */
        public UpdateActiveReleasePatchRequestBuilder patchOperation(List<PatchOperation> patchOperation) {
            this.patchOperation = patchOperation;
            return this;
        }

        /**
         * Build call for updateActiveReleasePatch
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute updateActiveReleasePatch request
         * @return Release
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public Release execute() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            ApiResponse<Release> localVarResp = updateActiveReleasePatchWithHttpInfo(projectKey, flagKey, patchOperation);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateActiveReleasePatch request with HTTP info returned
         * @return ApiResponse&lt;Release&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<Release> executeWithHttpInfo() throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateActiveReleasePatchWithHttpInfo(projectKey, flagKey, patchOperation);
        }

        /**
         * Execute updateActiveReleasePatch request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Release> _callback) throws ApiException {
            List<PatchOperation> patchOperation = buildBodyParams();
            return updateActiveReleasePatchAsync(projectKey, flagKey, patchOperation, _callback);
        }
    }
     ...
     */
    public UpdateActiveReleasePatchRequestBuilder updateActiveReleasePatch(String projectKey, String flagKey) throws IllegalArgumentException {
        if (projectKey == null) throw new IllegalArgumentException("\"projectKey\" is required but got null");
        ...
        return new UpdateActiveReleasePatchRequestBuilder(projectKey, flagKey);
    }
}
