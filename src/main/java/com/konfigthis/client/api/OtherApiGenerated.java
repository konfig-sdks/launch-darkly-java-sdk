...
import com.konfigthis.client.model.RootResponse;
import com.konfigthis.client.model.VersionsRep;
...
public class OtherApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public OtherApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public OtherApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getIpListCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getIpListValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getIpListCall(_callback);

    }


    private ApiResponse<IpList> getIpListWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getIpListValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<IpList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getIpListAsync(final ApiCallback<IpList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIpListValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<IpList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetIpListRequestBuilder {

        private GetIpListRequestBuilder() {
        }
        ...
        public IpList execute() throws ApiException {
            ApiResponse<IpList> localVarResp = getIpListWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getIpList request with HTTP info returned
        ...
        public ApiResponse<IpList> executeWithHttpInfo() throws ApiException {
            return getIpListWithHttpInfo();
        }

        /**
         * Execute getIpList request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<IpList> _callback) throws ApiException {
            return getIpListAsync(_callback);
        }
    }
     ...
     * @return GetIpListRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Public IP response </td><td>  -  </td></tr>
     ...
     */
    public GetIpListRequestBuilder getIpList() throws IllegalArgumentException {
        return new GetIpListRequestBuilder();
    }
    ...
    private ApiResponse<Void> getOpenapiSpecWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getOpenapiSpecValidateBeforeCall(null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call getOpenapiSpecAsync(final ApiCallback<Void> _callback) throws ApiException {
    ...
    private okhttp3.Call getResourceCategoriesCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<RootResponse> getResourceCategoriesWithHttpInfo() throws ApiException {
    ...
    private okhttp3.Call getResourceCategoriesAsync(final ApiCallback<RootResponse> _callback) throws ApiException {
    ...
    public class GetResourceCategoriesRequestBuilder {

        private GetResourceCategoriesRequestBuilder() {
        }
        ...
        /**
         * Execute getResourceCategories request
         * @return RootResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public RootResponse execute() throws ApiException {
            ApiResponse<RootResponse> localVarResp = getResourceCategoriesWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getResourceCategories request with HTTP info returned
         ...
         */
        public ApiResponse<RootResponse> executeWithHttpInfo() throws ApiException {
            return getResourceCategoriesWithHttpInfo();
        }

        /**
         * Execute getResourceCategories request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RootResponse> _callback) throws ApiException {
            return getResourceCategoriesAsync(_callback);
        }
    }
     ...
     * @return GetResourceCategoriesRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Root response </td><td>  -  </td></tr>
     ...
     */
    public GetResourceCategoriesRequestBuilder getResourceCategories() throws IllegalArgumentException {
        return new GetResourceCategoriesRequestBuilder();
    }
    ...
    private ApiResponse<VersionsRep> getVersionInformationWithHttpInfo() throws ApiException {
    ...
    private okhttp3.Call getVersionInformationAsync(final ApiCallback<VersionsRep> _callback) throws ApiException {
    ...
    public class GetVersionInformationRequestBuilder {
         ...
         */
        public VersionsRep execute() throws ApiException {
            ApiResponse<VersionsRep> localVarResp = getVersionInformationWithHttpInfo();
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<VersionsRep> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<VersionsRep> _callback) throws ApiException {
