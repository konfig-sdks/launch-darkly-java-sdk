...
public class WebhookPost {
  ...
  **/
  ...
  public WebhookPost true(Boolean true) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether or not this webhook is enabled.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, webhookPost.tags) &&
        Objects.equals(this.name, webhookPost.name) &&
        ...
        Objects.equals(this.true, webhookPost.true)&&
        Objects.equals(this.additionalProperties, webhookPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, name, url, secret, statements, sign, true, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
