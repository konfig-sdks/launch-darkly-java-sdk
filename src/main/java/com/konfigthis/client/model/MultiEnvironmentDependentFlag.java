...
import com.konfigthis.client.model.DependentFlagEnvironment;
...
public class MultiEnvironmentDependentFlag {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MultiEnvironmentDependentFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
