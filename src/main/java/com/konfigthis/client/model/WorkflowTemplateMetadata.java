...
import com.konfigthis.client.model.WorkflowTemplateParameter;
...
public class WorkflowTemplateMetadata {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowTemplateMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
