...
public class DestinationPost {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GOOGLE_PUBSUB", value = "The type of Data Export destination")
  ...
  **/
  ...
  public DestinationPost true(Boolean true) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, destinationPost.name) &&
        ...
        Objects.equals(this.true, destinationPost.true)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, kind, config, true, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DestinationPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
