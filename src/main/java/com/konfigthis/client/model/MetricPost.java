...
public class MetricPost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, metricPost.tags) &&
        Objects.equals(this.description, metricPost.description) &&
        Objects.equals(this.key, metricPost.key) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, key, name, kind, selector, urls, isActive, isNumeric, unit, eventKey, successCriteria, randomizationUnits, unitAggregationType, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
