...
public class AccessTokenPost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, accessTokenPost.description) &&
        Objects.equals(this.name, accessTokenPost.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, role, customRoleIds, inlineRole, serviceToken, defaultApiVersion, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccessTokenPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
