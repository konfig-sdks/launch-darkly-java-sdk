...
public class InstructionUserRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, instructionUserRequest.version) &&
        Objects.equals(this.kind, instructionUserRequest.kind) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, kind, flagKey, variationId, value, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstructionUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
