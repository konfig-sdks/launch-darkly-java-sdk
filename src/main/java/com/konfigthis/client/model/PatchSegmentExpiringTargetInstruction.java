...
public class PatchSegmentExpiringTargetInstruction {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, patchSegmentExpiringTargetInstruction.version) &&
        Objects.equals(this.kind, patchSegmentExpiringTargetInstruction.kind) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, kind, contextKey, contextKind, targetType, value, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchSegmentExpiringTargetInstruction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
