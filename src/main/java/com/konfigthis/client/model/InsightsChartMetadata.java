...
import com.konfigthis.client.model.InsightsChartMetric;
import com.konfigthis.client.model.InsightsChartSeriesMetadataAxis;
...
public class InsightsChartMetadata {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsChartMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
