...
import com.konfigthis.client.model.ExperimentAllocationRep;
import com.konfigthis.client.model.WeightedVariation;
...
public class Rollout {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Rollout.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
