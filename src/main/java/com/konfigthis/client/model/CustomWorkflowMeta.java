...
import com.konfigthis.client.model.CustomWorkflowStageMeta;
...
public class CustomWorkflowMeta {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomWorkflowMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
