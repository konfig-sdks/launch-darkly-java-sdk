...
import com.konfigthis.client.model.BigSegmentStoreIntegrationCollectionLinks;
...
public class BigSegmentStoreIntegrationCollection {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BigSegmentStoreIntegrationCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
