...
import com.konfigthis.client.model.FlagEventExperimentIteration;
...
public class FlagEventExperiment {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlagEventExperiment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
