...
public class MetricEventDefaultRep {
  ...
  **/
  ...
  public MetricEventDefaultRep value(Double value) {
  ...
  public MetricEventDefaultRep value(Integer value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricEventDefaultRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
