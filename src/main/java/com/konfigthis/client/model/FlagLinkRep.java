...
import com.konfigthis.client.model.FlagLinkMember;
import com.konfigthis.client.model.Link;
import com.konfigthis.client.model.TimestampRep;
...
public class FlagLinkRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, flagLinkRep.title) &&
        Objects.equals(this.description, flagLinkRep.description) &&
        Objects.equals(this.links, flagLinkRep.links) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, links, key, integrationKey, id, deepLink, timestamp, metadata, createdAt, member, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlagLinkRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
