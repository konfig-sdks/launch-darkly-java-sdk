...
public class RelativeDifferenceRep {
  ...
  public RelativeDifferenceRep upper(Double upper) {
  ...
  public RelativeDifferenceRep upper(Integer upper) {
  ...
  **/
  ...
  public RelativeDifferenceRep lower(Double lower) {
  ...
  public RelativeDifferenceRep lower(Integer lower) {
  ...
  **/
   ...
   * @return the RelativeDifferenceRep instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RelativeDifferenceRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
