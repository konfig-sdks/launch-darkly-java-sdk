...
import com.konfigthis.client.model.FlagEventExperimentCollection;
import com.konfigthis.client.model.FlagEventImpactRep;
import com.konfigthis.client.model.FlagEventMemberRep;
...
public class FlagEventRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, flagEventRep.description) &&
        Objects.equals(this.id, flagEventRep.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, projectId, projectKey, environmentId, environmentKey, flagKey, eventType, eventTime, auditLogEntryId, member, actions, impact, experiments, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlagEventRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
