...
public class CreateCopyFlagConfigApprovalRequestRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, createCopyFlagConfigApprovalRequestRequest.description) &&
        Objects.equals(this.comment, createCopyFlagConfigApprovalRequestRequest.comment) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, comment, notifyMemberIds, notifyTeamKeys, source, includedActions, excludedActions, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateCopyFlagConfigApprovalRequestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
