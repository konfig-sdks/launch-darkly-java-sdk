...
import com.konfigthis.client.model.ParameterDefault;
...
public class WorkflowTemplateParameter {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowTemplateParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
