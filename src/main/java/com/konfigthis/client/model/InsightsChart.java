...
import com.konfigthis.client.model.InsightsChartMetadata;
import com.konfigthis.client.model.InsightsChartSeries;
...
public class InsightsChart {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsChart.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
