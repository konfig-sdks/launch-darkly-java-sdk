...
import com.konfigthis.client.model.IntegrationStatusRep;
...
public class IntegrationSubscriptionStatusRep {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IntegrationSubscriptionStatusRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
