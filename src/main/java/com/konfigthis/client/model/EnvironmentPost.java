...
public class EnvironmentPost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, environmentPost.tags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, name, key, color, defaultTtl, secureMode, defaultTrackEvents, confirmChanges, requireComments, source, critical, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EnvironmentPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
