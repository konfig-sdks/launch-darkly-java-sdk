...
public class CustomRolePost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, customRolePost.description) &&
        Objects.equals(this.name, customRolePost.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, key, policy, basePermissions, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomRolePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
