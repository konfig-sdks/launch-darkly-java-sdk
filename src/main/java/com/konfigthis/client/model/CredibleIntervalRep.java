...
public class CredibleIntervalRep {
  ...
  public CredibleIntervalRep upper(Double upper) {
  ...
  public CredibleIntervalRep upper(Integer upper) {
  ...
  **/
  ...
  public CredibleIntervalRep lower(Double lower) {
  ...
  public CredibleIntervalRep lower(Integer lower) {
  ...
  **/
   ...
   * @return the CredibleIntervalRep instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CredibleIntervalRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
