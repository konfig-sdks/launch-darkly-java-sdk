...
public class ExperimentPost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, experimentPost.description) &&
        Objects.equals(this.name, experimentPost.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, maintainerId, key, iteration, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExperimentPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
