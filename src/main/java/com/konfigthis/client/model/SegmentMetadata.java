...
public class SegmentMetadata {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, segmentMetadata.version) &&
        Objects.equals(this.envId, segmentMetadata.envId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, envId, segmentId, includedCount, excludedCount, lastModified, deleted, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
