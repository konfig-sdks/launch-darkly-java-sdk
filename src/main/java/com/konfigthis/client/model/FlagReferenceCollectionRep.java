...
import com.konfigthis.client.model.FlagReferenceRep;
...
public class FlagReferenceCollectionRep {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlagReferenceCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
