...
public class ConditionInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, conditionInput.description) &&
        Objects.equals(this.scheduleKind, conditionInput.scheduleKind) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, scheduleKind, executionDate, waitDuration, waitDurationUnit, executeNow, notifyMemberIds, notifyTeamKeys, kind, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConditionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
