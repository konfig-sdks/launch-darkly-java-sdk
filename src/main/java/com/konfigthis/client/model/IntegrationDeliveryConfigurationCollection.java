...
import com.konfigthis.client.model.IntegrationDeliveryConfigurationCollectionLinks;
...
public class IntegrationDeliveryConfigurationCollection {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IntegrationDeliveryConfigurationCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
