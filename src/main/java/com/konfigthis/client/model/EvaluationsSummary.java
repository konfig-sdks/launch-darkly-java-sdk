...
import com.konfigthis.client.model.VariationEvalSummary;
...
public class EvaluationsSummary {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EvaluationsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
