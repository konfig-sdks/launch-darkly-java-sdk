...
public class PatchSegmentInstruction {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, patchSegmentInstruction.version) &&
        Objects.equals(this.kind, patchSegmentInstruction.kind) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, kind, userKey, targetType, value, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchSegmentInstruction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
