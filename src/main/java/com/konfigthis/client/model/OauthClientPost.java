...
public class OauthClientPost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, oauthClientPost.description) &&
        Objects.equals(this.name, oauthClientPost.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, redirectUri, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OauthClientPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
