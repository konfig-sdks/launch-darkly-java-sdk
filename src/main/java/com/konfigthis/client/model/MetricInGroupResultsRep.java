...
public class MetricInGroupResultsRep {
  ...
  **/
   ...
   * @return the MetricInGroupResultsRep instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricInGroupResultsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
