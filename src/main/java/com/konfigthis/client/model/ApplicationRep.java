...
import com.konfigthis.client.model.ApplicationFlagCollectionRep;
...
public class ApplicationRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, applicationRep.description) &&
        Objects.equals(this.flags, applicationRep.flags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, flags, access, links, version, autoAdded, creationDate, key, kind, maintainer, name, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicationRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
