...
import com.konfigthis.client.model.StoreIntegrationError;
...
public class BigSegmentStoreStatus {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BigSegmentStoreStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
