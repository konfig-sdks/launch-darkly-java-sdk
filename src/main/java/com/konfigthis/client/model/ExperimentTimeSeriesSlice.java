...
import com.konfigthis.client.model.ExperimentTimeSeriesVariationSlice;
...
public class ExperimentTimeSeriesSlice {
  ...
  **/
   ...
   * @return the ExperimentTimeSeriesSlice instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExperimentTimeSeriesSlice.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("VariationData") != null && !jsonObj.get("VariationData").isJsonNull()) {
