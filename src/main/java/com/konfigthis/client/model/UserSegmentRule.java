...
import com.konfigthis.client.model.Clause;
...
public class UserSegmentRule {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, userSegmentRule.description) &&
        Objects.equals(this.id, userSegmentRule.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, clauses, weight, rolloutContextKind, bucketBy, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserSegmentRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
