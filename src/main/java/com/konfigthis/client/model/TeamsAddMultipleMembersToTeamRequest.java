...
public class TeamsAddMultipleMembersToTeamRequest {
  public static final String SERIALIZED_NAME_FILE = "file";
  @SerializedName(SERIALIZED_NAME_FILE)
  private File _file;

  public TeamsAddMultipleMembersToTeamRequest() {
  }

  public TeamsAddMultipleMembersToTeamRequest _file(File _file) {
  ...
  **/
  ...
  @ApiModelProperty(value = "CSV file containing email addresses")
   ...
   * @return the TeamsAddMultipleMembersToTeamRequest instance itself
   */
  public TeamsAddMultipleMembersToTeamRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamsAddMultipleMembersToTeamRequest teamsAddMultipleMembersToTeamRequest = (TeamsAddMultipleMembersToTeamRequest) o;
    return Objects.equals(this._file, teamsAddMultipleMembersToTeamRequest._file)&&
        Objects.equals(this.additionalProperties, teamsAddMultipleMembersToTeamRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamsAddMultipleMembersToTeamRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamsAddMultipleMembersToTeamRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamsAddMultipleMembersToTeamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamsAddMultipleMembersToTeamRequest is not found in the empty JSON string", TeamsAddMultipleMembersToTeamRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamsAddMultipleMembersToTeamRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamsAddMultipleMembersToTeamRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamsAddMultipleMembersToTeamRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamsAddMultipleMembersToTeamRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamsAddMultipleMembersToTeamRequest>() {
           @Override
           public void write(JsonWriter out, TeamsAddMultipleMembersToTeamRequest value) throws IOException {
           ...
           @Override
           public TeamsAddMultipleMembersToTeamRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamsAddMultipleMembersToTeamRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamsAddMultipleMembersToTeamRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamsAddMultipleMembersToTeamRequest
  * @throws IOException if the JSON string is invalid with respect to TeamsAddMultipleMembersToTeamRequest
  */
  public static TeamsAddMultipleMembersToTeamRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamsAddMultipleMembersToTeamRequest.class);
  }

 /**
  * Convert an instance of TeamsAddMultipleMembersToTeamRequest to an JSON string
  *
  * @return JSON string
  */
