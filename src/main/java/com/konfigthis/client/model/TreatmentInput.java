...
import com.konfigthis.client.model.TreatmentParameterInput;
...
public class TreatmentInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parameters, treatmentInput.parameters) &&
        Objects.equals(this.name, treatmentInput.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(parameters, name, baseline, allocationPercent, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TreatmentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
