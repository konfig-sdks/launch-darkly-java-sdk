...
import com.konfigthis.client.model.InsightGroupsCountByIndicator;
...
public class InsightGroupCollectionMetadata {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightGroupCollectionMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
