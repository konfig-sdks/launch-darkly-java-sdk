...
public class StatisticRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, statisticRep.version) &&
        Objects.equals(this.name, statisticRep.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, name, type, sourceLink, defaultBranch, enabled, hunkCount, fileCount, links, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatisticRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
