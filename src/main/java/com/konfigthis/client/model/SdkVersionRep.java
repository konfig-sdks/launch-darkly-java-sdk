...
public class SdkVersionRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, sdkVersionRep.version) &&
        Objects.equals(this.sdk, sdkVersionRep.sdk)&&
        Objects.equals(this.additionalProperties, sdkVersionRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, sdk, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SdkVersionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
