...
import com.konfigthis.client.model.EvaluationsSummary;
...
public class FlagEventImpactRep {
  ...
  **/
  ...
  public FlagEventImpactRep percentage(Double percentage) {
  ...
  public FlagEventImpactRep percentage(Integer percentage) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlagEventImpactRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
