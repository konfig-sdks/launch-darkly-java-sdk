...
import com.konfigthis.client.model.InsightsMetricIndicatorRange;
...
public class InsightsMetricScore {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsMetricScore.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
