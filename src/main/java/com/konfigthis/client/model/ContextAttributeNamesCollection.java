...
import com.konfigthis.client.model.ContextAttributeNames;
...
public class ContextAttributeNamesCollection {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextAttributeNamesCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
