...
public class ExperimentStatsRep {
  ...
  public ExperimentStatsRep pValue(Double pValue) {
  ...
  public ExperimentStatsRep pValue(Integer pValue) {
  ...
  **/
  ...
  public ExperimentStatsRep chi2(Double chi2) {
  ...
  public ExperimentStatsRep chi2(Integer chi2) {
    
    
    
    
    this.chi2 = chi2.doubleValue();
    return this;
  }
  ...
  **/
   ...
   * @return the ExperimentStatsRep instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExperimentStatsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
