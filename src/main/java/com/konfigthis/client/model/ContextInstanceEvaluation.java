...
import com.konfigthis.client.model.ContextInstanceEvaluationReason;
...
public class ContextInstanceEvaluation {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextInstanceEvaluation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
