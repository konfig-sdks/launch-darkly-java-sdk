...
import com.konfigthis.client.model.ContextAttributeValues;
...
public class ContextAttributeValuesCollection {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextAttributeValuesCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
