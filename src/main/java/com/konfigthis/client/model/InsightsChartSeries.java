...
import com.konfigthis.client.model.InsightsChartSeriesDataPoint;
import com.konfigthis.client.model.InsightsChartSeriesMetadata;
...
public class InsightsChartSeries {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsChartSeries.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
