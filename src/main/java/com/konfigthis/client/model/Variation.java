...
public class Variation {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, value, name, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Variation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
