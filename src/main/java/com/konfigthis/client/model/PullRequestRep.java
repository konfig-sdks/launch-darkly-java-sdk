...
import com.konfigthis.client.model.FlagReferenceCollectionRep;
import com.konfigthis.client.model.PullRequestLeadTimeRep;
...
public class PullRequestRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, pullRequestRep.title) &&
        Objects.equals(this.id, pullRequestRep.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, id, externalId, status, author, createTime, mergeTime, mergeCommitKey, baseCommitKey, headCommitKey, filesChanged, linesAdded, linesDeleted, url, deployments, flagReferences, leadTime, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PullRequestRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
