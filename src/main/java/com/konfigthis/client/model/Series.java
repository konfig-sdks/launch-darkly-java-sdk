...
public class Series {
  ...
  **/
  ...
  public Series value(Double value) {
  ...
  public Series value(Integer value) {
  ...
  **/
   ...
   * @return the Series instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Series.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
