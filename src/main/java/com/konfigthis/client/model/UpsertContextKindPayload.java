...
public class UpsertContextKindPayload {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, upsertContextKindPayload.description) &&
        Objects.equals(this.version, upsertContextKindPayload.version) &&
        Objects.equals(this.name, upsertContextKindPayload.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, version, name, hideInTargeting, archived, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpsertContextKindPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
