...
public class SegmentBody {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, segmentBody.tags) &&
        Objects.equals(this.description, segmentBody.description) &&
        Objects.equals(this.name, segmentBody.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, name, key, unbounded, unboundedContextKind, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
