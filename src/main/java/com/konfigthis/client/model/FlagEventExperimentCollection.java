...
import com.konfigthis.client.model.FlagEventExperiment;
...
public class FlagEventExperimentCollection {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlagEventExperimentCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
