...
public class CreateWorkflowTemplateInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, createWorkflowTemplateInput.description) &&
        Objects.equals(this.key, createWorkflowTemplateInput.key) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, key, name, workflowId, stages, projectKey, environmentKey, flagKey, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateWorkflowTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
