...
public class CreateReleasePipelineInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, createReleasePipelineInput.tags) &&
        Objects.equals(this.description, createReleasePipelineInput.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, key, name, phases, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateReleasePipelineInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
