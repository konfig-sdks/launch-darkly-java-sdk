...
public class MetricGroupPost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, metricGroupPost.tags) &&
        Objects.equals(this.description, metricGroupPost.description) &&
        Objects.equals(this.key, metricGroupPost.key) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, key, name, kind, maintainerId, metrics, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricGroupPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
