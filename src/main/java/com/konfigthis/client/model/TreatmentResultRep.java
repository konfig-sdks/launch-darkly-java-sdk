...
import com.konfigthis.client.model.CredibleIntervalRep;
import com.konfigthis.client.model.Distribution;
import com.konfigthis.client.model.RelativeDifferenceRep;
...
public class TreatmentResultRep {
  ...
  **/
  ...
  public TreatmentResultRep mean(Double mean) {
  ...
  public TreatmentResultRep mean(Integer mean) {
  ...
  **/
  ...
  public TreatmentResultRep pBest(Double pBest) {
  ...
  public TreatmentResultRep pBest(Integer pBest) {
    
    
    
    
    this.pBest = pBest.doubleValue();
    return this;
  }
  ...
  **/
   ...
   * @return the TreatmentResultRep instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TreatmentResultRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
