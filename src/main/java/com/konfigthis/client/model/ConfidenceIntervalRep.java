...
public class ConfidenceIntervalRep {
  ...
  public ConfidenceIntervalRep upper(Double upper) {
  ...
  public ConfidenceIntervalRep upper(Integer upper) {
  ...
  **/
  ...
  public ConfidenceIntervalRep lower(Double lower) {
  ...
  public ConfidenceIntervalRep lower(Integer lower) {
  ...
  **/
   ...
   * @return the ConfidenceIntervalRep instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConfidenceIntervalRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
