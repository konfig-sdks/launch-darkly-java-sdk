...
public class Distribution {
  ...
  **/
   ...
   * @return the Distribution instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parameters, distribution.parameters) &&
        Objects.equals(this.kind, distribution.kind)&&
        Objects.equals(this.additionalProperties, distribution.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parameters, kind, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Distribution.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
