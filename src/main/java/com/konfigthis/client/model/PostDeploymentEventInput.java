...
public class PostDeploymentEventInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, postDeploymentEventInput.version) &&
        Objects.equals(this.projectKey, postDeploymentEventInput.projectKey) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, projectKey, environmentKey, applicationKey, applicationName, applicationKind, versionName, eventType, eventTime, eventMetadata, deploymentMetadata, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostDeploymentEventInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
