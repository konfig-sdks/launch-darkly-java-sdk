...
public class PatchSegmentRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "[{\"version\":0,\"contextKey\":\"contextKey\",\"contextKind\":\"user\",\"kind\":\"updateExpiringTarget\",\"targetType\":\"included\",\"value\":1587582000000}]", required = true, value = "Semantic patch instructions for the desired changes to the resource")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchSegmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
