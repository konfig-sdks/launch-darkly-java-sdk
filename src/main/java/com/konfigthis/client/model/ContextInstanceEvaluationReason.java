...
public class ContextInstanceEvaluationReason {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", required = true, value = "Describes the general reason that LaunchDarkly selected this variation.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextInstanceEvaluationReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
