...
import com.konfigthis.client.model.ExperimentEnabledPeriodRep;
...
public class ExperimentEnvironmentSettingRep {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExperimentEnvironmentSettingRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
