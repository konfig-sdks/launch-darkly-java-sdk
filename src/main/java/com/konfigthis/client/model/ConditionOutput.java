...
import com.konfigthis.client.model.ReviewOutput;
...
public class ConditionOutput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, conditionOutput.description) &&
        Objects.equals(this.id, conditionOutput.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, kind, execution, scheduleKind, executionDate, waitDuration, waitDurationUnit, notifyMemberIds, allReviews, reviewStatus, appliedDate, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConditionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
