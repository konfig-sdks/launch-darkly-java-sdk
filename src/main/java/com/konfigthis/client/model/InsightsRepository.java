...
import com.konfigthis.client.model.ProjectSummaryCollection;
...
public class InsightsRepository {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, insightsRepository.version) &&
        Objects.equals(this.id, insightsRepository.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, id, key, type, url, mainBranch, projects, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
