...
import com.konfigthis.client.model.ParameterRep;
...
public class TreatmentRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parameters, treatmentRep.parameters) &&
        Objects.equals(this.id, treatmentRep.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(parameters, id, name, allocationPercent, baseline, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TreatmentRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
