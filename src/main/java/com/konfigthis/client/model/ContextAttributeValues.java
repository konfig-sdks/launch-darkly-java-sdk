...
import com.konfigthis.client.model.ContextAttributeValue;
...
public class ContextAttributeValues {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextAttributeValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
