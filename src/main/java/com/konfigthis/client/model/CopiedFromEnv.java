...
public class CopiedFromEnv {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, copiedFromEnv.version) &&
        Objects.equals(this.key, copiedFromEnv.key)&&
        Objects.equals(this.additionalProperties, copiedFromEnv.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, key, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CopiedFromEnv.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
