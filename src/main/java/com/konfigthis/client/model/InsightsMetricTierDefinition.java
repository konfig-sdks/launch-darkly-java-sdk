...
public class InsightsMetricTierDefinition {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, insightsMetricTierDefinition.description) &&
        Objects.equals(this.indicator, insightsMetricTierDefinition.indicator)&&
        Objects.equals(this.additionalProperties, insightsMetricTierDefinition.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, indicator, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsMetricTierDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
