...
public class FlagLinkPost {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, flagLinkPost.title) &&
        Objects.equals(this.description, flagLinkPost.description) &&
        Objects.equals(this.key, flagLinkPost.key) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, key, integrationKey, timestamp, deepLink, metadata, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlagLinkPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
