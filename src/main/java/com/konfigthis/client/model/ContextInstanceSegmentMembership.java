...
public class ContextInstanceSegmentMembership {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, contextInstanceSegmentMembership.description) &&
        Objects.equals(this.name, contextInstanceSegmentMembership.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, key, unbounded, external, isMember, isIndividuallyTargeted, isRuleTargeted, links, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextInstanceSegmentMembership.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
