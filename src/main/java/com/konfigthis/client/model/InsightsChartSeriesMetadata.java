...
import com.konfigthis.client.model.InsightsChartBounds;
...
public class InsightsChartSeriesMetadata {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsChartSeriesMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
