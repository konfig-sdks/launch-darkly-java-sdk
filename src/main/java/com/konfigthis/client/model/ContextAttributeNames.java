...
import com.konfigthis.client.model.ContextAttributeName;
...
public class ContextAttributeNames {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextAttributeNames.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
