...
public class TeamPostInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, teamPostInput.description) &&
        Objects.equals(this.customRoleKeys, teamPostInput.customRoleKeys) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, customRoleKeys, key, memberIDs, name, permissionGrants, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamPostInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
