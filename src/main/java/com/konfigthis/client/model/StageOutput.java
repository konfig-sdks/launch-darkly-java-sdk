...
import com.konfigthis.client.model.ActionOutput;
import com.konfigthis.client.model.ConditionOutput;
...
public class StageOutput {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StageOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
