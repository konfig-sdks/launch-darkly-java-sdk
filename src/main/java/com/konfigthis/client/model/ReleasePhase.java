...
import com.konfigthis.client.model.Audience;
import com.konfigthis.client.model.CompletedBy;
...
public class ReleasePhase {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReleasePhase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
