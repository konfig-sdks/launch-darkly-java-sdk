...
public class ContextKindRep {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, contextKindRep.description) &&
        Objects.equals(this.version, contextKindRep.version) &&
        Objects.equals(this.key, contextKindRep.key) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, version, key, name, creationDate, lastModified, lastSeen, createdFrom, hideInTargeting, archived, links, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextKindRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
