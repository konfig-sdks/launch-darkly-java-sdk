...
import com.konfigthis.client.model.ActionInput;
import com.konfigthis.client.model.ConditionInput;
...
public class StageInput {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StageInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
