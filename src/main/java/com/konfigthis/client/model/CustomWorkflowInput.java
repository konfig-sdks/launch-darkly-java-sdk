...
public class CustomWorkflowInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, customWorkflowInput.description) &&
        Objects.equals(this.maintainerId, customWorkflowInput.maintainerId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, maintainerId, name, stages, templateKey, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomWorkflowInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
