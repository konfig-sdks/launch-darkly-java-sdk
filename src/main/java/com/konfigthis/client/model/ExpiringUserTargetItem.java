...
import com.konfigthis.client.model.ResourceIDResponse;
...
public class ExpiringUserTargetItem {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExpiringUserTargetItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
