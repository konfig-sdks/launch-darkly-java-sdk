...
public class SegmentsBetaStartBigSegmentImportRequest {
  ...
  public SegmentsBetaStartBigSegmentImportRequest() {
  }

  public SegmentsBetaStartBigSegmentImportRequest _file(File _file) {
  ...
  **/
  ...
  @ApiModelProperty(value = "CSV file containing keys")
  ...
  public SegmentsBetaStartBigSegmentImportRequest mode(String mode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Import mode. Use either `merge` or `replace`")
   ...
   * @return the SegmentsBetaStartBigSegmentImportRequest instance itself
   */
  public SegmentsBetaStartBigSegmentImportRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentsBetaStartBigSegmentImportRequest segmentsBetaStartBigSegmentImportRequest = (SegmentsBetaStartBigSegmentImportRequest) o;
    return Objects.equals(this._file, segmentsBetaStartBigSegmentImportRequest._file) &&
        Objects.equals(this.mode, segmentsBetaStartBigSegmentImportRequest.mode)&&
        Objects.equals(this.additionalProperties, segmentsBetaStartBigSegmentImportRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_file, mode, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SegmentsBetaStartBigSegmentImportRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentsBetaStartBigSegmentImportRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentsBetaStartBigSegmentImportRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentsBetaStartBigSegmentImportRequest is not found in the empty JSON string", SegmentsBetaStartBigSegmentImportRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentsBetaStartBigSegmentImportRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentsBetaStartBigSegmentImportRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentsBetaStartBigSegmentImportRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentsBetaStartBigSegmentImportRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentsBetaStartBigSegmentImportRequest>() {
           @Override
           public void write(JsonWriter out, SegmentsBetaStartBigSegmentImportRequest value) throws IOException {
           ...
           @Override
           public SegmentsBetaStartBigSegmentImportRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentsBetaStartBigSegmentImportRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentsBetaStartBigSegmentImportRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentsBetaStartBigSegmentImportRequest
  * @throws IOException if the JSON string is invalid with respect to SegmentsBetaStartBigSegmentImportRequest
  */
  public static SegmentsBetaStartBigSegmentImportRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentsBetaStartBigSegmentImportRequest.class);
  }

 /**
  * Convert an instance of SegmentsBetaStartBigSegmentImportRequest to an JSON string
  *
  * @return JSON string
  */
