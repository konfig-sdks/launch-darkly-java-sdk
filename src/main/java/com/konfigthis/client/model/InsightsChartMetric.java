...
import com.konfigthis.client.model.InsightsMetricTierDefinition;
...
public class InsightsChartMetric {
  ...
  **/
  ...
  public InsightsChartMetric value(Double value) {
  ...
  public InsightsChartMetric value(Integer value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InsightsChartMetric.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
