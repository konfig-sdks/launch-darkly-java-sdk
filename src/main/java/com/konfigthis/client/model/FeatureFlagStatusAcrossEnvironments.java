...
import com.konfigthis.client.model.FeatureFlagStatus;
...
public class FeatureFlagStatusAcrossEnvironments {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FeatureFlagStatusAcrossEnvironments.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
