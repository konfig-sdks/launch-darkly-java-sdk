...
public class CodeReferencesApiTest {
    ...
    private static CodeReferencesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CodeReferencesApi(apiClient);
    }
     ...
     */
    @Test
    public void asynchronouslyDeleteBranchesTest() throws ApiException {
        String repo = null;
        api.asynchronouslyDeleteBranches(repo)
                .execute();
     ...
     */
    @Test
    public void createExtinctionTest() throws ApiException {
        String repo = null;
        String branch = null;
        api.createExtinction(repo, branch)
                .execute();
        // TODO: test validations
    }
    ...
    public void createRepositoryTest() throws ApiException {
        ...
        String hunkUrlTemplate = null;
        String type = null;
        String defaultBranch = null;
        RepositoryRep response = api.createRepository(name)
    ...
    public void getBranchTest() throws ApiException {
        ...
        String projKey = null;
        String flagKey = null;
        BranchRep response = api.getBranch(repo, branch)
                .projKey(projKey)
                .flagKey(flagKey)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getRepositoryByRepoTest() throws ApiException {
        String repo = null;
        RepositoryRep response = api.getRepositoryByRepo(repo)
                .execute();
        // TODO: test validations
    }
    ...
    public void getStatisticsTest() throws ApiException {
        StatisticsRoot response = api.getStatistics()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getStatistics_0Test() throws ApiException {
        String projectKey = null;
        String flagKey = null;
        StatisticCollectionRep response = api.getStatistics_0(projectKey)
                .flagKey(flagKey)
                .execute();
        // TODO: test validations
    }
    ...
    public void listBranchesTest() throws ApiException {
        String repo = null;
        BranchCollectionRep response = api.listBranches(repo)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listExtinctionsTest() throws ApiException {
        ...
        Long from = null;
        Long to = null;
        ExtinctionCollectionRep response = api.listExtinctions()
                .repoName(repoName)
    ...
    public void listRepositoriesTest() throws ApiException {
        ...
        String projKey = null;
        String flagKey = null;
        RepositoryCollectionRep response = api.listRepositories()
     ...
     */
    @Test
    public void updateRepositorySettingsTest() throws ApiException {
        String repo = null;
        RepositoryRep response = api.updateRepositorySettings(repo)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void upsertBranchTest() throws ApiException {
        String name = null;
        String head = null;
        Long syncTime = null;
        String repo = null;
        String branch = null;
        Long updateSequenceId = null;
        List<ReferenceRep> references = null;
        Long commitTime = null;
        api.upsertBranch(name, head, syncTime, repo, branch)
