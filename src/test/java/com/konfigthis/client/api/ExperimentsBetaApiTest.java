...
public class ExperimentsBetaApiTest {
    ...
    private static ExperimentsBetaApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ExperimentsBetaApi(apiClient);
    }
    ...
    public void createIterationTest() throws ApiException {
        ...
        List<MetricInput> metrics = null;
        List<TreatmentInput> treatments = null;
        Map<String, FlagInput> flags = null;
        String projectKey = null;
        String environmentKey = null;
        String experimentKey = null;
        Boolean canReshuffleTraffic = null;
        String primarySingleMetricKey = null;
        String primaryFunnelKey = null;
        String randomizationUnit = null;
        IterationRep response = api.createIteration(hypothesis, metrics, treatments, flags, projectKey, environmentKey, experimentKey)
    ...
    public void createNewTest() throws ApiException {
        String name = null;
        String key = null;
        IterationInput iteration = null;
        String projectKey = null;
        String environmentKey = null;
        String description = null;
        String maintainerId = null;
        Experiment response = api.createNew(name, key, iteration, projectKey, environmentKey)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String experimentKey = null;
        String expand = null;
        Experiment response = api.getDetails(projectKey, environmentKey, experimentKey)
                .expand(expand)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getExperimentMetricResultsTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String experimentKey = null;
        ...
        String expand = null;
        ExperimentBayesianResultsRep response = api.getExperimentMetricResults(projectKey, environmentKey, experimentKey, metricKey)
    ...
    public void getLegacyExperimentResultsTest() throws ApiException {
        ...
        Long from = null;
        Long to = null;
        ExperimentResults response = api.getLegacyExperimentResults(projectKey, featureFlagKey, environmentKey, metricKey)
                .from(from)
                .to(to)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getResultsForMetricGroupTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String experimentKey = null;
        String metricGroupKey = null;
        String iterationId = null;
        MetricGroupResultsRep response = api.getResultsForMetricGroup(projectKey, environmentKey, experimentKey, metricGroupKey)
                .iterationId(iterationId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listExperimentsInEnvironmentTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        Long limit = null;
        Long offset = null;
        ...
        ExperimentCollectionRep response = api.listExperimentsInEnvironment(projectKey, environmentKey)
                .limit(limit)
                .offset(offset)
                .filter(filter)
                .expand(expand)
     ...
     */
    @Test
    public void updateExperimentationSettingsTest() throws ApiException {
        List<RandomizationUnitInput> randomizationUnits = null;
        String projectKey = null;
        RandomizationSettingsRep response = api.updateExperimentationSettings(randomizationUnits, projectKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateSemanticPatchTest() throws ApiException {
        List<Map<String, Object>> instructions = null;
        String projectKey = null;
        String environmentKey = null;
        String experimentKey = null;
        String comment = null;
        Experiment response = api.updateSemanticPatch(instructions, projectKey, environmentKey, experimentKey)
                .comment(comment)
                .execute();
        // TODO: test validations
    }
