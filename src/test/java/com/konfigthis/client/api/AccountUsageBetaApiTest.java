...
public class AccountUsageBetaApiTest {
    ...
    private static AccountUsageBetaApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new AccountUsageBetaApi(apiClient);
    }
    ...
    public void getEvaluationsUsageTest() throws ApiException {
        ...
        String to = null;
        String tz = null;
        SeriesListRep response = api.getEvaluationsUsage(projectKey, environmentKey, featureFlagKey)
                .from(from)
                .to(to)
                .tz(tz)
                .execute();
     ...
     */
    @Test
    public void getEventsUsageDataTest() throws ApiException {
        String type = null;
        String from = null;
        String to = null;
        SeriesListRep response = api.getEventsUsageData(type)
                .from(from)
                .to(to)
                .execute();
        // TODO: test validations
    ...
    public void getExperimentationKeysUsageTest() throws ApiException {
        String from = null;
        String to = null;
        SeriesIntervalsRep response = api.getExperimentationKeysUsage()
                .from(from)
                .to(to)
                .execute();
        // TODO: test validations
    ...
    public void getExperimentationUnitsUsageTest() throws ApiException {
        String from = null;
        String to = null;
        SeriesIntervalsRep response = api.getExperimentationUnitsUsage()
                .from(from)
                .to(to)
                .execute();
        // TODO: test validations
    ...
    public void getMauUsageByCategoryTest() throws ApiException {
        String from = null;
        String to = null;
        SeriesListRep response = api.getMauUsageByCategory()
                .from(from)
                .to(to)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getMauUsageDataTest() throws ApiException {
        String from = null;
        String to = null;
        String project = null;
        ...
        String groupby = null;
        SeriesListRep response = api.getMauUsageData()
                .from(from)
                .to(to)
                .project(project)
    ...
    public void getStreamUsageTest() throws ApiException {
        ...
        String to = null;
        String tz = null;
        SeriesListRep response = api.getStreamUsage(source)
                .from(from)
                .to(to)
                .tz(tz)
                .execute();
     ...
     */
    @Test
    public void getStreamUsageBySdkVersionDataTest() throws ApiException {
        String source = null;
        String from = null;
        String to = null;
        String tz = null;
        String sdk = null;
        String version = null;
        SeriesListRep response = api.getStreamUsageBySdkVersionData(source)
                .from(from)
                .to(to)
                .tz(tz)
                .sdk(sdk)
     ...
     */
    @Test
    public void listMauSdksByTypeTest() throws ApiException {
        String from = null;
        String to = null;
        String sdktype = null;
        SdkListRep response = api.listMauSdksByType()
                .from(from)
                .to(to)
                .sdktype(sdktype)
                .execute();
     ...
     */
    @Test
    public void listSdkVersionsTest() throws ApiException {
        String source = null;
        SdkVersionListRep response = api.listSdkVersions(source)
                .execute();
        // TODO: test validations
    }
