...
public class ContextsApiTest {
    ...
    private static ContextsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ContextsApi(apiClient);
    }
     ...
     */
    @Test
    public void createOrUpdateKindTest() throws ApiException {
        String name = null;
        String projectKey = null;
        String key = null;
        String description = null;
        Integer version = null;
        Boolean hideInTargeting = null;
        Boolean archived = null;
        UpsertResponseRep response = api.createOrUpdateKind(name, projectKey, key)
     ...
     */
    @Test
    public void deleteContextInstanceTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String id = null;
        api.deleteContextInstance(projectKey, environmentKey, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void evaluateFlagsForContextInstanceTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        Long limit = null;
        Long offset = null;
        String sort = null;
        String filter = null;
        ContextInstanceEvaluations response = api.evaluateFlagsForContextInstance(projectKey, environmentKey)
                .limit(limit)
                .offset(offset)
                .sort(sort)
                .filter(filter)
     ...
     */
    @Test
    public void getAttributeNamesTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String filter = null;
        ContextAttributeNamesCollection response = api.getAttributeNames(projectKey, environmentKey)
                .filter(filter)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getByKindAndKeyTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String kind = null;
        String key = null;
        ...
        Contexts response = api.getByKindAndKey(projectKey, environmentKey, kind, key)
                .limit(limit)
    ...
    public void getContextAttributeValuesTest() throws ApiException {
        ...
        String filter = null;
        ContextAttributeValuesCollection response = api.getContextAttributeValues(projectKey, environmentKey, attributeName)
                .filter(filter)
                .execute();
        // TODO: test validations
    }
    ...
    public void getContextInstancesTest() throws ApiException {
        ...
        String filter = null;
        Boolean includeTotalCount = null;
        ContextInstances response = api.getContextInstances(projectKey, environmentKey, id)
                .limit(limit)
                .continuationToken(continuationToken)
                .sort(sort)
                .filter(filter)
     ...
     */
    @Test
    public void listContextKindsByProjectTest() throws ApiException {
        String projectKey = null;
        ContextKindsCollectionRep response = api.listContextKindsByProject(projectKey)
                .execute();
        // TODO: test validations
    }
    ...
    public void searchContextInstancesTest() throws ApiException {
        ...
        String filter = null;
        Boolean includeTotalCount = null;
        ContextInstances response = api.searchContextInstances(projectKey, environmentKey)
                .filter(filter)
                .sort(sort)
                .limit(limit)
                .continuationToken(continuationToken)
    ...
    public void searchContextsTest() throws ApiException {
        ...
        String filter = null;
        Boolean includeTotalCount = null;
        Contexts response = api.searchContexts(projectKey, environmentKey)
                .filter(filter)
                .sort(sort)
                .limit(limit)
                .continuationToken(continuationToken)
