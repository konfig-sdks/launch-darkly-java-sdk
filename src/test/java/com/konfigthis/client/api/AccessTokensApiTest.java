...
public class AccessTokensApiTest {
    ...
    private static AccessTokensApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new AccessTokensApi(apiClient);
    }
     ...
     */
    @Test
    public void createNewTokenTest() throws ApiException {
        String description = null;
        String name = null;
        String role = null;
        List<String> customRoleIds = null;
        List<StatementPost> inlineRole = null;
        Boolean serviceToken = null;
        Integer defaultApiVersion = null;
        Token response = api.createNewToken()
     ...
     */
    @Test
    public void resetSecretKeyTest() throws ApiException {
        String id = null;
        Long expiry = null;
        Token response = api.resetSecretKey(id)
                .expiry(expiry)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateSettingsTest() throws ApiException {
        String id = null;
        Token response = api.updateSettings(id)
                .execute();
        // TODO: test validations
    }
