...
public class SegmentsApiTest {
    ...
    public void createSegmentTest() throws ApiException {
        ...
        UserSegment response = api.createSegment(name, key, projectKey, environmentKey)
                .tags(tags)
     ...
     */
    @Test
    public void evaluateSegmentMembershipsTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        ContextInstanceSegmentMemberships response = api.evaluateSegmentMemberships(projectKey, environmentKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getContextMembershipTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        String contextKey = null;
        BigSegmentTarget response = api.getContextMembership(projectKey, environmentKey, segmentKey, contextKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getExpiringTargetsTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        ExpiringTargetGetResponse response = api.getExpiringTargets(projectKey, environmentKey, segmentKey)
                .execute();
        // TODO: test validations
    }
    ...
    public void getExpiringUserTargetsTest() throws ApiException {
        ...
        String environmentKey = null;
        String segmentKey = null;
        ExpiringUserTargetGetResponse response = api.getExpiringUserTargets(projectKey, environmentKey, segmentKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getSegmentListTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        Long limit = null;
        Long offset = null;
        String sort = null;
        String filter = null;
        UserSegments response = api.getSegmentList(projectKey, environmentKey)
                .limit(limit)
                .offset(offset)
                .sort(sort)
                .filter(filter)
     ...
     */
    @Test
    public void getUserMembershipStatusTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        String userKey = null;
        BigSegmentTarget response = api.getUserMembershipStatus(projectKey, environmentKey, segmentKey, userKey)
                .execute();
        // TODO: test validations
    }
    ...
    public void removeSegmentTest() throws ApiException {
        ...
        String environmentKey = null;
        String segmentKey = null;
        api.removeSegment(projectKey, environmentKey, segmentKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void singleSegmentByKeyTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        UserSegment response = api.singleSegmentByKey(projectKey, environmentKey, segmentKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateContextTargetsTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        SegmentUserList included = null;
        SegmentUserList excluded = null;
        api.updateContextTargets(projectKey, environmentKey, segmentKey)
                .included(included)
                .excluded(excluded)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void updateExpiringTargetsForSegmentTest() throws ApiException {
        List<PatchSegmentExpiringTargetInstruction> instructions = null;
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        String comment = null;
        ExpiringTargetPatchResponse response = api.updateExpiringTargetsForSegment(instructions, projectKey, environmentKey, segmentKey)
                .comment(comment)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateExpiringTargetsForSegment_0Test() throws ApiException {
        List<PatchSegmentInstruction> instructions = null;
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        String comment = null;
        ExpiringUserTargetPatchResponse response = api.updateExpiringTargetsForSegment_0(instructions, projectKey, environmentKey, segmentKey)
                .comment(comment)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateSemanticPatchTest() throws ApiException {
        List<PatchOperation> patch = null;
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        String comment = null;
        UserSegment response = api.updateSemanticPatch(patch, projectKey, environmentKey, segmentKey)
                .comment(comment)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateUserContextTargetsTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String segmentKey = null;
        SegmentUserList included = null;
        SegmentUserList excluded = null;
        api.updateUserContextTargets(projectKey, environmentKey, segmentKey)
                .included(included)
                .excluded(excluded)
                .execute();
        // TODO: test validations
