...
public class ApprovalsApiTest {
    ...
    private static ApprovalsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ApprovalsApi(apiClient);
    }
     ...
     */
    @Test
    public void applyRequestFlagTest() throws ApiException {
        String id = null;
        String comment = null;
        ApprovalRequestResponse response = api.applyRequestFlag(id)
                .comment(comment)
                .execute();
     ...
     */
    @Test
    public void applyRequestFlag_0Test() throws ApiException {
        String projectKey = null;
        String featureFlagKey = null;
        String environmentKey = null;
        String id = null;
        String comment = null;
        FlagConfigApprovalRequestResponse response = api.applyRequestFlag_0(projectKey, featureFlagKey, environmentKey, id)
                .comment(comment)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void createFlagCopyRequestTest() throws ApiException {
        String description = null;
        SourceFlag source = null;
        String projectKey = null;
        String featureFlagKey = null;
        String environmentKey = null;
        String comment = null;
        List<String> notifyMemberIds = null;
        List<String> notifyTeamKeys = null;
        List<String> includedActions = null;
        List<String> excludedActions = null;
        FlagConfigApprovalRequestResponse response = api.createFlagCopyRequest(description, source, projectKey, featureFlagKey, environmentKey)
                .comment(comment)
     ...
     */
    @Test
    public void createRequestFlagTest() throws ApiException {
        String description = null;
        ...
        List<String> notifyMemberIds = null;
        List<String> notifyTeamKeys = null;
        Map<String, Object> integrationConfig = null;
        ApprovalRequestResponse response = api.createRequestFlag(description, resourceId, instructions)
                .comment(comment)
                .notifyMemberIds(notifyMemberIds)
                .notifyTeamKeys(notifyTeamKeys)
     ...
     */
    @Test
    public void createRequestFlag_0Test() throws ApiException {
        String description = null;
        List<Map<String, Object>> instructions = null;
        String projectKey = null;
        String featureFlagKey = null;
        ...
        String operatingOnId = null;
        Map<String, Object> integrationConfig = null;
        FlagConfigApprovalRequestResponse response = api.createRequestFlag_0(description, instructions, projectKey, featureFlagKey, environmentKey)
                .comment(comment)
                .notifyMemberIds(notifyMemberIds)
                .notifyTeamKeys(notifyTeamKeys)
     ...
     */
    @Test
    public void deleteApprovalRequestFlagTest() throws ApiException {
        String projectKey = null;
        String featureFlagKey = null;
        String environmentKey = null;
        String id = null;
        api.deleteApprovalRequestFlag(projectKey, featureFlagKey, environmentKey, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getRequestByIdTest() throws ApiException {
        String id = null;
        String expand = null;
        ExpandableApprovalRequestResponse response = api.getRequestById(id)
                .expand(expand)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Long limit = null;
        Long offset = null;
        ExpandableApprovalRequestsResponse response = api.list()
                .filter(filter)
                .expand(expand)
                .limit(limit)
                .offset(offset)
     ...
     */
    @Test
    public void listRequestsForFlagTest() throws ApiException {
        String projectKey = null;
        String featureFlagKey = null;
        String environmentKey = null;
        FlagConfigApprovalRequestsResponse response = api.listRequestsForFlag(projectKey, featureFlagKey, environmentKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void reviewFlagRequestTest() throws ApiException {
        String projectKey = null;
        String featureFlagKey = null;
        String environmentKey = null;
        String id = null;
        String kind = null;
        String comment = null;
        FlagConfigApprovalRequestResponse response = api.reviewFlagRequest(projectKey, featureFlagKey, environmentKey, id)
                .kind(kind)
                .comment(comment)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void reviewRequestTest() throws ApiException {
        String id = null;
        String kind = null;
        String comment = null;
        ApprovalRequestResponse response = api.reviewRequest(id)
                .kind(kind)
                .comment(comment)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void singleRequestTest() throws ApiException {
        String projectKey = null;
        String featureFlagKey = null;
        String environmentKey = null;
        String id = null;
        FlagConfigApprovalRequestResponse response = api.singleRequest(projectKey, featureFlagKey, environmentKey, id)
                .execute();
        // TODO: test validations
    }
