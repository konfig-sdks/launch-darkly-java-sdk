...
public class EnvironmentsApiTest {
     ...
     */
    @Test
    public void createNewEnvironmentTest() throws ApiException {
        String name = null;
        String key = null;
        String color = null;
        ...
        Boolean defaultTrackEvents = null;
        Boolean confirmChanges = null;
        Boolean requireComments = null;
        SourceEnv source = null;
        Boolean critical = null;
        Environment response = api.createNewEnvironment(name, key, color, projectKey)
                .tags(tags)
     ...
     */
    @Test
    public void getByProjectAndKeyTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        Environment response = api.getByProjectAndKey(projectKey, environmentKey)
                .execute();
        // TODO: test validations
    }
    ...
    public void listEnvironmentsTest() throws ApiException {
        ...
        String filter = null;
        String sort = null;
        Environments response = api.listEnvironments(projectKey)
                .limit(limit)
                .offset(offset)
                .filter(filter)
                .sort(sort)
     ...
     */
    @Test
    public void removeByEnvironmentKeyTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        api.removeByEnvironmentKey(projectKey, environmentKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void resetMobileSdkKeyTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        Environment response = api.resetMobileSdkKey(projectKey, environmentKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void resetSdkKeyTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        Long expiry = null;
        Environment response = api.resetSdkKey(projectKey, environmentKey)
                .expiry(expiry)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateEnvironmentPatchTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        Environment response = api.updateEnvironmentPatch(projectKey, environmentKey)
                .execute();
        // TODO: test validations
    }
