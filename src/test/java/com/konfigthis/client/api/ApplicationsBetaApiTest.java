...
public class ApplicationsBetaApiTest {
    ...
    private static ApplicationsBetaApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ApplicationsBetaApi(apiClient);
    }
     ...
     */
    @Test
    public void getApplicationByKeyTest() throws ApiException {
        String applicationKey = null;
        String expand = null;
        ApplicationRep response = api.getApplicationByKey(applicationKey)
                .expand(expand)
                .execute();
    ...
    public void getApplicationVersionsTest() throws ApiException {
        ...
        Long offset = null;
        String sort = null;
        ApplicationVersionsCollectionRep response = api.getApplicationVersions(applicationKey)
                .filter(filter)
                .limit(limit)
                .offset(offset)
                .sort(sort)
    ...
    public void listApplicationsTest() throws ApiException {
        ...
        String sort = null;
        String expand = null;
        ApplicationCollectionRep response = api.listApplications()
                .filter(filter)
                .limit(limit)
                .offset(offset)
                .sort(sort)
     ...
     */
    @Test
    public void removeApplicationTest() throws ApiException {
        String applicationKey = null;
        api.removeApplication(applicationKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void removeVersionTest() throws ApiException {
        String applicationKey = null;
        String versionKey = null;
        api.removeVersion(applicationKey, versionKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateApplicationPatchTest() throws ApiException {
        String applicationKey = null;
        ApplicationRep response = api.updateApplicationPatch(applicationKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateVersionPatchTest() throws ApiException {
        String applicationKey = null;
        String versionKey = null;
        ApplicationVersionRep response = api.updateVersionPatch(applicationKey, versionKey)
                .execute();
        // TODO: test validations
    }
