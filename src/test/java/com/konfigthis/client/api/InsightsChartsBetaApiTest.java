...
/**
 * API tests for InsightsChartsBetaApi
 */
@Disabled
public class InsightsChartsBetaApiTest {

    private static InsightsChartsBetaApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new InsightsChartsBetaApi(apiClient);
    }
     ...
     */
    @Test
    public void deploymentFrequencyChartDataTest() throws ApiException {
        ...
        String groupBy = null;
        String expand = null;
        InsightsChart response = api.deploymentFrequencyChartData()
     ...
     */
    @Test
    public void getFlagStatusChartDataTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String applicationKey = null;
        InsightsChart response = api.getFlagStatusChartData(projectKey, environmentKey)
                .applicationKey(applicationKey)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void leadTimeChartDataTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String applicationKey = null;
        Long from = null;
        ...
        String groupBy = null;
        String expand = null;
        InsightsChart response = api.leadTimeChartData(projectKey)
                .environmentKey(environmentKey)
                .applicationKey(applicationKey)
                .from(from)
                .to(to)
     ...
     */
    @Test
    public void releaseFrequencyDataTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String applicationKey = null;
        Boolean hasExperiments = null;
        String global = null;
        String groupBy = null;
        OffsetDateTime from = null;
        OffsetDateTime to = null;
        ...
        Long bucketMs = null;
        String expand = null;
        InsightsChart response = api.releaseFrequencyData(projectKey, environmentKey)
                .applicationKey(applicationKey)
     ...
     */
    @Test
    public void staleFlagsChartDataTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String applicationKey = null;
        String groupBy = null;
        ...
        String expand = null;
        InsightsChart response = api.staleFlagsChartData(projectKey, environmentKey)
                .applicationKey(applicationKey)
                .groupBy(groupBy)
