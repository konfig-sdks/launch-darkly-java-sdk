...
|------------- | ------------- | -------------|
| [**acrossEnvironments**](FeatureFlagsApi.md#acrossEnvironments) | **GET** /api/v2/flag-status/{projectKey}/{featureFlagKey} | Get flag status across environments |
| [**copyFlagSettings**](FeatureFlagsApi.md#copyFlagSettings) | **POST** /api/v2/flags/{projectKey}/{featureFlagKey}/copy | Copy feature flag |
| [**createFeatureFlag**](FeatureFlagsApi.md#createFeatureFlag) | **POST** /api/v2/flags/{projectKey} | Create a feature flag |
| [**deleteFlag**](FeatureFlagsApi.md#deleteFlag) | **DELETE** /api/v2/flags/{projectKey}/{featureFlagKey} | Delete feature flag |
| [**getContextInstanceSegmentsMembershipByEnv**](FeatureFlagsApi.md#getContextInstanceSegmentsMembershipByEnv) | **GET** /api/v2/flags/{projectKey}/{featureFlagKey}/expiring-targets/{environmentKey} | Get expiring context targets for feature flag |
| [**getStatus**](FeatureFlagsApi.md#getStatus) | **GET** /api/v2/flag-statuses/{projectKey}/{environmentKey}/{featureFlagKey} | Get feature flag status |
| [**list**](FeatureFlagsApi.md#list) | **GET** /api/v2/flags/{projectKey} | List feature flags |
| [**listExpiringUserTargets**](FeatureFlagsApi.md#listExpiringUserTargets) | **GET** /api/v2/flags/{projectKey}/{featureFlagKey}/expiring-user-targets/{environmentKey} | Get expiring user targets for feature flag |
| [**listFlagStatuses**](FeatureFlagsApi.md#listFlagStatuses) | **GET** /api/v2/flag-statuses/{projectKey}/{environmentKey} | List feature flag statuses |
| [**singleFlagByKey**](FeatureFlagsApi.md#singleFlagByKey) | **GET** /api/v2/flags/{projectKey}/{featureFlagKey} | Get feature flag |
| [**updateExpiringContextTargets**](FeatureFlagsApi.md#updateExpiringContextTargets) | **PATCH** /api/v2/flags/{projectKey}/{featureFlagKey}/expiring-targets/{environmentKey} | Update expiring context targets on feature flag |
| [**updateExpiringUserTargets**](FeatureFlagsApi.md#updateExpiringUserTargets) | **PATCH** /api/v2/flags/{projectKey}/{featureFlagKey}/expiring-user-targets/{environmentKey} | Update expiring user targets on feature flag |
| [**updateFeatureFlag**](FeatureFlagsApi.md#updateFeatureFlag) | **PATCH** /api/v2/flags/{projectKey}/{featureFlagKey} | Update feature flag |


<a name="acrossEnvironments"></a>
# **acrossEnvironments**
> FeatureFlagStatusAcrossEnvironments acrossEnvironments(projectKey, featureFlagKey).env(env).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String env = "env_example"; // Optional environment filter
    try {
      FeatureFlagStatusAcrossEnvironments result = client
              .featureFlags
              .acrossEnvironments(projectKey, featureFlagKey)
              .env(env)
              .execute();
      ...
      System.err.println("Exception when calling FeatureFlagsApi#acrossEnvironments");
    ...
    try {
      ApiResponse<FeatureFlagStatusAcrossEnvironments> response = client
              .featureFlags
              .acrossEnvironments(projectKey, featureFlagKey)
              .env(env)
              .executeWithHttpInfo();
...
<a name="copyFlagSettings"></a>
# **copyFlagSettings**
> FeatureFlag copyFlagSettings(projectKey, featureFlagKey, flagCopyConfigPost).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    configuration.apiKey  = "YOUR API KEY";
    LaunchDarkly client = new LaunchDarkly(configuration);
    FlagCopyConfigEnvironment source = new FlagCopyConfigEnvironment();
    FlagCopyConfigEnvironment target = new FlagCopyConfigEnvironment();
    String projectKey = "projectKey_example"; // The project key
    String featureFlagKey = "featureFlagKey_example"; // The feature flag key. The key identifies the flag in your code.
    String comment = "comment_example"; // Optional comment
    List<String> includedActions = Arrays.asList(); // Optional list of the flag changes to copy from the source environment to the target environment. You may include either <code>includedActions</code> or <code>excludedActions</code>, but not both. If you include neither, then all flag changes will be copied.
    List<String> excludedActions = Arrays.asList(); // Optional list of the flag changes NOT to copy from the source environment to the target environment. You may include either  <code>includedActions</code> or <code>excludedActions</code>, but not both. If you include neither, then all flag changes will be copied.
    try {
      FeatureFlag result = client
              .featureFlags
              .copyFlagSettings(source, target, projectKey, featureFlagKey)
              .comment(comment)
      ...
      System.out.println(result.getIncludeInSnippet());
      System.out.println(result.getClientSideAvailability());
      System.out.println(result.getVariations());
      System.out.println(result.getTemporary());
      System.out.println(result.getLinks());
      System.out.println(result.getMaintainerId());
      System.out.println(result.getMaintainer());
      System.out.println(result.getMaintainerTeamKey());
      System.out.println(result.getMaintainerTeam());
      System.out.println(result.getGoalIds());
      ...
      System.out.println(result.getDeprecated());
      System.out.println(result.getDeprecatedDate());
      System.out.println(result.getDefaults());
      System.out.println(result.getPurpose());
      System.out.println(result.getMigrationSettings());
      System.out.println(result.getEnvironments());
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#copyFlagSettings");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<FeatureFlag> response = client
              .featureFlags
              .copyFlagSettings(source, target, projectKey, featureFlagKey)
              .comment(comment)
              .includedActions(includedActions)
...
# **createFeatureFlag**
> FeatureFlag createFeatureFlag(projectKey, featureFlagBody).clone(clone).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    configuration.apiKey  = "YOUR API KEY";
    LaunchDarkly client = new LaunchDarkly(configuration);
    String name = "name_example"; // A human-friendly name for the feature flag
    String key = "key_example"; // A unique key used to reference the flag in your code
    String projectKey = "projectKey_example"; // The project key
    List<String> tags = Arrays.asList(); // Tags for the feature flag. Defaults to an empty array.
    String description = "description_example"; // Description of the feature flag. Defaults to an empty string.
    Boolean includeInSnippet = true; // Deprecated, use <code>clientSideAvailability</code>. Whether this flag should be made available to the client-side JavaScript SDK. Defaults to <code>false</code>.
    ClientSideAvailabilityPost clientSideAvailability = new ClientSideAvailabilityPost();
    List<Variation> variations = Arrays.asList(); // An array of possible variations for the flag. The variation values must be unique. If omitted, two boolean variations of <code>true</code> and <code>false</code> will be used.
    Boolean temporary = true; // Whether the flag is a temporary flag. Defaults to <code>true</code>.
    Map<String, CustomProperty> customProperties = new HashMap();
    Defaults defaults = new Defaults();
    String purpose = "migration"; // Purpose of the flag
    MigrationSettingsPost migrationSettings = new MigrationSettingsPost();
    String clone = "clone_example"; // The key of the feature flag to be cloned. The key identifies the flag in your code. For example, setting `clone=flagKey` copies the full targeting configuration for all environments, including `on/off` state, from the original flag to the new flag.
    try {
      FeatureFlag result = client
              .featureFlags
              .createFeatureFlag(name, key, projectKey)
              .tags(tags)
...
<a name="deleteFlag"></a>
# **deleteFlag**
> deleteFlag(projectKey, featureFlagKey).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      client
              .featureFlags
              .deleteFlag(projectKey, featureFlagKey)
              .execute();
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#deleteFlag");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> ExpiringTargetGetResponse getContextInstanceSegmentsMembershipByEnv(projectKey, environmentKey, featureFlagKey).execute();
  ...
  public static void main(String[] args) {
    ...
    try {
      ExpiringTargetGetResponse result = client
              .featureFlags
              .getContextInstanceSegmentsMembershipByEnv(projectKey, environmentKey, featureFlagKey)
              .execute();
      System.out.println(result);
      System.out.println(result.getItems());
      System.out.println(result.getLinks());
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#getContextInstanceSegmentsMembershipByEnv");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getStatus"></a>
# **getStatus**
> FlagStatusRep getStatus(projectKey, environmentKey, featureFlagKey).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String featureFlagKey = "featureFlagKey_example"; // The feature flag key
    try {
      FlagStatusRep result = client
              .featureFlags
              .getStatus(projectKey, environmentKey, featureFlagKey)
              .execute();
      System.out.println(result);
      System.out.println(result.getLinks());
      System.out.println(result.getName());
      System.out.println(result.getLastRequested());
      System.out.println(result.getDefault());
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#getStatus");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<FlagStatusRep> response = client
              .featureFlags
              .getStatus(projectKey, environmentKey, featureFlagKey)
              .executeWithHttpInfo();
      System.out.println(response.getResponseBody());
...
<a name="list"></a>
# **list**
> FeatureFlags list(projectKey).env(env).tag(tag).limit(limit).offset(offset).archived(archived).summary(summary).filter(filter).sort(sort).compare(compare).expand(expand).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    LaunchDarkly client = new LaunchDarkly(configuration);
    String projectKey = "projectKey_example"; // The project key
    String env = "env_example"; // Filter configurations by environment
    String tag = "tag_example"; // Filter feature flags by tag
    ...
    Boolean archived = true; // Deprecated, use `filter=archived:true` instead. A boolean to filter the list to archived flags. When this is absent, only unarchived flags will be returned
    Boolean summary = true; // By default, flags do _not_ include their lists of prerequisites, targets, or rules for each environment. Set `summary=0` to include these fields for each flag returned.
    ...
    String sort = "sort_example"; // A comma-separated list of fields to sort by. Fields prefixed by a dash ( - ) sort in descending order. Read the endpoint description for a full list of available sort fields.
    Boolean compare = true; // A boolean to filter results by only flags that have differences between environments
    ...
    try {
      ...
      System.out.println(result.getTotalCountWithDifferences());
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#list");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<FeatureFlags> response = client
              .featureFlags
              .list(projectKey)
              .env(env)
              .tag(tag)
...
<a name="listExpiringUserTargets"></a>
# **listExpiringUserTargets**
> ExpiringUserTargetGetResponse listExpiringUserTargets(projectKey, environmentKey, featureFlagKey).execute();
  ...
  public static void main(String[] args) {
    ...
    try {
      ExpiringUserTargetGetResponse result = client
              .featureFlags
              .listExpiringUserTargets(projectKey, environmentKey, featureFlagKey)
              .execute();
      System.out.println(result);
      System.out.println(result.getItems());
      System.out.println(result.getLinks());
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#listExpiringUserTargets");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listFlagStatuses"></a>
# **listFlagStatuses**
> FeatureFlagStatuses listFlagStatuses(projectKey, environmentKey).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String environmentKey = "environmentKey_example"; // The environment key
    try {
      FeatureFlagStatuses result = client
              .featureFlags
              .listFlagStatuses(projectKey, environmentKey)
              .execute();
      System.out.println(result);
      System.out.println(result.getLinks());
      System.out.println(result.getItems());
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#listFlagStatuses");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<FeatureFlagStatuses> response = client
              .featureFlags
              .listFlagStatuses(projectKey, environmentKey)
              .executeWithHttpInfo();
      System.out.println(response.getResponseBody());
...
<a name="singleFlagByKey"></a>
# **singleFlagByKey**
> FeatureFlag singleFlagByKey(projectKey, featureFlagKey).env(env).expand(expand).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FeatureFlag result = client
              .featureFlags
              .singleFlagByKey(projectKey, featureFlagKey)
              .env(env)
              .expand(expand)
              .execute();
      System.out.println(result);
      ...
      System.err.println("Exception when calling FeatureFlagsApi#singleFlagByKey");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="updateExpiringContextTargets"></a>
# **updateExpiringContextTargets**
> ExpiringTargetPatchResponse updateExpiringContextTargets(projectKey, environmentKey, featureFlagKey, patchFlagsRequest).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    configuration.apiKey  = "YOUR API KEY";
    LaunchDarkly client = new LaunchDarkly(configuration);
    List<Map<String, Object>> instructions = Arrays.asList(new HashMap<>()); // The instructions to perform when updating
    String projectKey = "projectKey_example"; // The project key
    String environmentKey = "environmentKey_example"; // The environment key
    String featureFlagKey = "featureFlagKey_example"; // The feature flag key
    ...
    try {
      ExpiringTargetPatchResponse result = client
              .featureFlags
              .updateExpiringContextTargets(instructions, projectKey, environmentKey, featureFlagKey)
              .comment(comment)
              .execute();
      System.out.println(result);
      System.out.println(result.getItems());
      ...
      System.err.println("Exception when calling FeatureFlagsApi#updateExpiringContextTargets");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="updateExpiringUserTargets"></a>
# **updateExpiringUserTargets**
> ExpiringUserTargetPatchResponse updateExpiringUserTargets(projectKey, environmentKey, featureFlagKey, patchFlagsRequest).execute();
  ...
  public static void main(String[] args) {
    ...
    try {
      ExpiringUserTargetPatchResponse result = client
              .featureFlags
              .updateExpiringUserTargets(instructions, projectKey, environmentKey, featureFlagKey)
              .comment(comment)
              .execute();
      System.out.println(result);
      System.out.println(result.getItems());
      ...
      System.err.println("Exception when calling FeatureFlagsApi#updateExpiringUserTargets");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **updateFeatureFlag**
> FeatureFlag updateFeatureFlag(projectKey, featureFlagKey, patchWithComment).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FeatureFlag result = client
              .featureFlags
              .updateFeatureFlag(patch, projectKey, featureFlagKey)
              .comment(comment)
              .execute();
      System.out.println(result);
      System.out.println(result.getTags());
